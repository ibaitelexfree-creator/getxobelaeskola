...
import { type Tab, useMissionStore } from "@/store/useMissionStore";
				...
				{tabs.map((tab) => {
					...
					return (
						...
						>
							...
							<span
								className={`relative z-10 text-[9px] font-mono font-bold tracking-[0.15em] transition-all duration-500 ${
									isActive
										? "text-white/90 translate-y-0 opacity-100"
										: "text-white/20 translate-y-1 opacity-0"
								}`}
							>
