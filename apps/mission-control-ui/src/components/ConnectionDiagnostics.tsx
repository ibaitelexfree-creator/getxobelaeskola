...
export default function ConnectionDiagnostics() {
	...
	return (
		<div
			...
			className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500 overflow-y-auto pb-32 px-4"
		>
			{/* Status Header */}
			<div className="bg-status-red/10 border-2 border-status-red/30 rounded-[2.5rem] p-8 text-center relative overflow-hidden mt-6">
				...
				<h2
					suppressHydrationWarning
					className="text-white text-2xl font-black uppercase tracking-tight mb-2"
				>
				...
				<div className="space-y-6">
					...
					<div className="flex gap-3 pt-2">
						<button
							...
							disabled={isTesting}
							className={`flex-1 py-5 rounded-2xl border-2 flex items-center justify-center gap-3 transition-all active:scale-95 ${
								isTesting
						...
						>
							...
							<p
								className={`text-[11px] font-mono leading-relaxed ${
									testResult.success ? "text-status-green" : "text-status-red"
								}`}
							>
								{testResult.msg}
							</p>
