					...
					<div className="space-y-4">
						<div>
							<div className="flex justify-between items-end mb-1">
								...
								<span className="text-sm font-mono font-bold text-status-blue">
									{hardware.cpu.load}%
								</span>
							</div>
						...
						<div className="pt-2 border-t border-white/5">
							<div className="flex items-center gap-2">
								...
								<span className="ml-auto text-xs font-mono font-bold text-white/80">
									{hardware.cpu.temp || 42}°C
								</span>
							</div>
						</div>
					</div>
		...
		<div className="hidden lg:flex flex-col gap-6 w-48">
			...
			<div className="bg-[#0a0f1a]/80 border border-white/5 rounded-2xl p-4 backdrop-blur-md shadow-2xl relative overflow-hidden group">
				...
				<div className="space-y-4">
					<div>
						<div className="flex justify-between items-end mb-1">
							...
							<span className="text-sm font-mono font-bold text-status-green">
								{hardware.gpu.temp}°C
							</span>
						</div>
						<div className="h-1 w-full bg-white/5 rounded-full overflow-hidden">
							<motion.div
								...
								initial={{ width: 0 }}
								animate={{
									width: `${Math.min(100, (hardware.gpu.temp / 100) * 100)}%`,
								}}
							/>
						</div>
					</div>
					...
					<div>
						<div className="flex justify-between items-end mb-1">
							...
							<span className="text-sm font-mono font-bold text-status-amber">
								{hardware.gpu.hotspot}°C
							</span>
						</div>
						<div className="h-1 w-full bg-white/5 rounded-full overflow-hidden">
							<motion.div
								...
								initial={{ width: 0 }}
								animate={{
									width: `${Math.min(100, (hardware.gpu.hotspot / 110) * 100)}%`,
								}}
							/>
						</div>
					</div>
				...
				<div className="mt-4 pt-2 border-t border-white/5">
					<span className="text-[8px] font-mono text-white/20 uppercase block truncate">
						{hardware.gpu.name}
					</span>
				</div>
			</div>
