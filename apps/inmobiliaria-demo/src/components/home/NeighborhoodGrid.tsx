...
export const NeighborhoodGrid = () => {
    ...
    return (
        <section ref={elementRef as any} id="neighborhoods" className="section" style={{ backgroundColor: 'var(--bg-secondary)', overflow: 'hidden' }}>
            <div className="container">
                ...
                >
                    ...
                    <h2 className="section-title reveal-mask" style={{ animationDelay: '0.2s' }}>The Most Exclusive Postcodes</h2>
                </div>
                    ...
                    {NEIGHBORHOODS.map((neighborhood, index) => (
                        <Link
                            ...
                            style={{
                                ...
                                transition: `all 0.8s var(--ease-out) ${index * 0.1 + 0.3}s`
                            }}
