            ...
            <header className="border-b border-white/10 bg-white/5 backdrop-blur-md pt-24 pb-12">
                <div className="container mx-auto px-6">
                    ...
                    <p className="text-lg text-white/60 max-w-2xl font-light">
                        Domina el arte de la cabuyería. Selecciona un nudo para ver el paso a paso detallado.
                    </p>
                </div>
            </header>
            ...
            <main className="container mx-auto px-6 py-12">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    <div className="lg:col-span-4 space-y-2">
                        <h2 className="text-xs font-black uppercase tracking-widest text-white/40 mb-4 px-2">Catálogo de Nudos</h2>
                        {KNOTS_DATA.map((knot) => (
                            <button
                                key={knot.id}
                            ...
                            >
                                <div className="flex justify-between items-center">
                                    <span className="font-bold font-display italic text-lg">{knot.name}</span>
                                    {selectedKnot.id === knot.id && <span className="text-nautical-black">●</span>}
                                </div>
                                <div className={`text-xs mt-1 ${selectedKnot.id === knot.id ? 'text-nautical-black/60' : 'text-white/40'}`}>
