...
export class WindManager {
    ...
    public update(dt: number) {
        ...
        const gust = Math.sin(this.time * 0.5) * 1.0 + Math.sin(this.time * 2.3) * 0.5;
    ...
    public getApparentWind(boatVelocity: Vector3, boatHeading: number): ApparentWind {
        ...
        const windGlobalAngle = Math.atan2(apparentWindVector.x, apparentWindVector.z);
