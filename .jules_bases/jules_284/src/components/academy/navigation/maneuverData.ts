...
export const MANEUVERS: Maneuver[] = [
    {
        ...
        description: 'Maniobra para cambiar de amura pasando la proa por la línea del viento.',
        steps: [
            {
                id: 1,
                ...
                boatRotation: -45,
                sailAngle: 15,
                description: 'Navegando de ceñida (amura estribor). Preparados para virar.',
                windDirection: 0
            },
            {
                id: 2,
            ...
            },
            {
                ...
                boatRotation: 10,
                sailAngle: 0,
                description: 'Pasando el viento. Foque acuartelado para ayudar al giro.',
                windDirection: 0
            },
            {
                id: 5,
    ...
    },
    {
        ...
        description: 'Maniobra para cambiar de amura pasando la popa por la línea del viento.',
        steps: [
            {
                id: 1,
                ...
                boatRotation: 135,
                sailAngle: 60,
                description: 'Navegando al largo (amura babor). Preparados para trasluchar.',
                windDirection: 0
            },
            {
                id: 2,
    ...
    },
    {
        ...
        steps: [
            ...
            },
            {
                ...
                boatRotation: -120,
                sailAngle: 60,
                description: 'Arribar inmediatamente a un largo para alejarse y ganar espacio.',
                windDirection: 0,
                extraElement: { type: 'mob', x: 40, y: 80 }
            },
            {
        ...
        steps: [
            {
                ...
                boatRotation: -45,
                sailAngle: 0,
                description: 'Aproximación al muelle con velocidad controlada (motor o inercia).',
                windDirection: 0,
            ...
            },
            {
                ...
                boatRotation: 0,
                sailAngle: 0,
                description: 'Timón a la banda contraria para colocar el barco paralelo.',
                windDirection: 0,
                extraElement: { type: 'dock', x: 50, y: 20, rotation: 0 }
            },
            {
