...
export type AcademyEvent =
    ...
    | { name: 'quiz_attempt'; properties: { quizId: string; score: number; passed: boolean } }
    | { name: 'certificate_download'; properties: { courseId: string; certificateId: string } };

/**
 * Eventos de negocio y conversión
 */
export type BusinessEvent =
    | { name: 'checkout_start'; properties: { productId: string; type: 'course' | 'rental' } }
    | { name: 'purchase_success'; properties: { amount: number; currency: string; orderId: string } }
