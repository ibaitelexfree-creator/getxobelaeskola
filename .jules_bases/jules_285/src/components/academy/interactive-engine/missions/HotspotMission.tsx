...
export const HotspotMission: React.FC<Props> = ({ data }) => (
    <div className="text-center p-8 bg-purple-900/10 rounded-lg border border-purple-500/20">
        <h4 className="text-xl font-display text-purple-300 mb-4">Identificación Visual</h4>
        <p className="text-purple-100/60 mb-6">{data.descripcion || 'Selecciona las zonas correctas en la imagen.'}</p>
