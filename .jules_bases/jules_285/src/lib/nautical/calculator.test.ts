...
import { dmsToDecimal, decimalToDms, calculateDistance, calculateBearing, calculateEta, DMS, Coordinate } from './calculator';

describe('Nautical Calculator', () => {
  describe('dmsToDecimal', () => {
    it('converts N/E coordinates correctly', () => {
      const dms: DMS = { degrees: 43, minutes: 20, seconds: 30, direction: 'N' };
