import { Question } from '@/components/academy/evaluation/types';
...
export const perExamQuestions: ExamQuestion[] = [
    ...
    },
    {
        ...
        category: 'Nomenclatura Náutica',
        puntos: 1,
        enunciado_es: 'La distancia vertical desde la línea de flotación hasta la cubierta principal se llama:',
        enunciado_eu: '',
        opciones_json: [
            { id: 'a', texto: 'Calado' },
            { id: 'b', texto: 'Puntal' },
    ...
    },
    {
        ...
        category: 'Nomenclatura Náutica',
        puntos: 1,
        enunciado_es: 'La estructura transversal que une los costados y soporta la cubierta se llama:',
        enunciado_eu: '',
        opciones_json: [
            { id: 'a', texto: 'Cuaderna' },
            { id: 'b', texto: 'Vao' },
    ...
    },
    {
        ...
        category: 'Amarre y Fondeo',
        puntos: 1,
        enunciado_es: 'Al fondear, ¿qué longitud de cadena se recomienda filar si hay buen tiempo?',
        enunciado_eu: '',
        opciones_json: [
    ...
    },
    {
        ...
        category: 'Amarre y Fondeo',
        puntos: 1,
        enunciado_es: '¿Qué nudo se utiliza habitualmente para afirmar una amarra a un noray?',
        enunciado_eu: '',
        opciones_json: [
    ...
    },
    {
        ...
        category: 'Seguridad',
        puntos: 1,
        enunciado_es: 'Para apagar un incendio de combustible líquido (Clase B), ¿qué extintor es más adecuado?',
        enunciado_eu: '',
        opciones_json: [
    ...
    },
    {
        ...
        category: 'Seguridad',
        puntos: 1,
        enunciado_es: '¿Qué es obligatorio llevar puesto en cubierta con mal tiempo?',
        enunciado_eu: '',
        opciones_json: [
    ...
    },
    {
        ...
        category: 'Seguridad',
        puntos: 1,
        enunciado_es: '¿Cuándo se considera que una embarcación tiene estabilidad positiva?',
        enunciado_eu: '',
        opciones_json: [
            { id: 'a', texto: 'Cuando al escorar tiende a volver a su posición inicial' },
            { id: 'b', texto: 'Cuando al escorar vuelca inmediatamente' },
            { id: 'c', texto: 'Cuando permanece escorada sin moverse' },
            { id: 'd', texto: 'Cuando el centro de gravedad está por encima del metacentro' }
        ],
        correctAnswer: 'a'
    },
    {
        ...
        category: 'Seguridad',
        puntos: 1,
        enunciado_es: '¿Qué elemento de seguridad es obligatorio para todos los tripulantes?',
        enunciado_eu: '',
        opciones_json: [
    ...
    // 4. Legislación (3)
    {
        ...
        puntos: 1,
        enunciado_es: '¿Cuál es la distancia mínima a la costa para descargar aguas sucias sin tratar?',
        enunciado_eu: '',
        opciones_json: [
            { id: 'a', texto: '3 millas' },
            { id: 'b', texto: '4 millas' },
    ...
    // 5. Balizamiento (6)
    {
        ...
        puntos: 1,
        enunciado_es: 'En la Región A (Europa), ¿de qué color es la marca lateral de estribor al entrar a puerto?',
        enunciado_eu: '',
        opciones_json: [
            { id: 'a', texto: 'Roja' },
            { id: 'b', texto: 'Verde' },
    ...
    },
    {
        ...
        category: 'Balizamiento',
        puntos: 1,
        enunciado_es: '¿Qué forma tiene la marca de tope de una boya de peligro aislado?',
        enunciado_eu: '',
        opciones_json: [
    ...
    },
    {
        ...
        category: 'Balizamiento',
        puntos: 1,
        enunciado_es: '¿Qué indica una boya con franjas verticales rojas y blancas?',
        enunciado_eu: '',
        opciones_json: [
    ...
    },
    {
        ...
        enunciado_eu: '',
        opciones_json: [
            { id: 'a', texto: 'Dos conos negros superpuestos con los vértices hacia arriba' },
            { id: 'b', texto: 'Dos conos negros superpuestos con los vértices hacia abajo' },
    ...
    },
    {
        ...
        category: 'Balizamiento',
        puntos: 1,
        enunciado_es: 'Si vemos una boya verde con una franja roja horizontal en el centro, indica:',
        enunciado_eu: '',
        opciones_json: [
    ...
    // 6. RIPA (12)
    {
        ...
        category: 'RIPA',
        puntos: 1,
        enunciado_es: 'En una situación de cruce entre dos buques de propulsión mecánica, ¿quién debe maniobrar?',
        enunciado_eu: '',
        opciones_json: [
    ...
    },
    {
        ...
        category: 'RIPA',
        puntos: 1,
        enunciado_es: '¿Qué luces debe exhibir un buque de propulsión mecánica en navegación de noche?',
        enunciado_eu: '',
        opciones_json: [
    ...
    },
    {
        ...
        category: 'RIPA',
        puntos: 1,
        enunciado_es: 'En caso de vuelta encontrada (de frente), ¿cómo deben maniobrar los buques?',
        enunciado_eu: '',
        opciones_json: [
    ...
    },
    {
        ...
        category: 'RIPA',
        puntos: 1,
        enunciado_es: '¿Qué buque tiene preferencia: un velero o un buque de propulsión mecánica?',
        enunciado_eu: '',
        opciones_json: [
            { id: 'a', texto: 'El buque de propulsión mecánica' },
            { id: 'b', texto: 'El velero (salvo excepciones como capacidad de maniobra restringida)' },
    ...
    },
    {
        ...
        opciones_json: [
            ...
            { id: 'b', texto: 'Una luz blanca todo horizonte en el lugar más visible' },
    ...
    },
    {
        ...
        category: 'RIPA',
        puntos: 1,
        enunciado_es: 'Si oímos dos pitadas largas cada dos minutos en niebla, indica:',
        enunciado_eu: '',
        opciones_json: [
            { id: 'a', texto: 'Buque de propulsión mecánica en navegación con arrancada' },
            { id: 'b', texto: 'Buque de propulsión mecánica en navegación sin arrancada' },
    ...
    },
    {
        ...
        category: 'RIPA',
        puntos: 1,
        enunciado_es: '¿Qué indica una luz amarilla sobre una blanca todo horizonte?',
        enunciado_eu: '',
        opciones_json: [
    ...
    },
    {
        ...
        opciones_json: [
            ...
            { id: 'b', texto: 'Lo más cerca posible del límite exterior que quede por su estribor' },
            { id: 'c', texto: 'Lo más cerca posible del límite exterior que quede por su babor' },
    ...
    },
    {
        ...
        category: 'RIPA',
        puntos: 1,
        enunciado_es: '¿Qué buque exhibe tres luces todo horizonte en línea vertical: roja, blanca, roja?',
        enunciado_eu: '',
        opciones_json: [
    ...
    },
    {
        ...
        enunciado_eu: '',
        opciones_json: [
            { id: 'a', texto: 'El que se aproxima a otro viniendo desde una dirección de más de 22.5 grados a popa del través' },
    ...
    },
    {
        ...
        category: 'Maniobra',
        puntos: 1,
        enunciado_es: 'Para amarrar de punta (popa al muelle), ¿qué cabo se da primero habitualmente?',
        enunciado_eu: '',
        opciones_json: [
    ...
    },
    {
        ...
        category: 'Maniobra',
        puntos: 1,
        enunciado_es: '¿Qué efecto produce la presión lateral de las palas en una hélice dextrógira dando atrás?',
        enunciado_eu: '',
        opciones_json: [
    ...
    // 8. Emergencias (4)
    {
        ...
        puntos: 1,
        enunciado_es: 'En caso de "Hombre al agua", la maniobra de Anderson consiste en:',
        enunciado_eu: '',
        opciones_json: [
    ...
    },
    {
        ...
        category: 'Emergencias',
        puntos: 1,
        enunciado_es: 'Si fallan el sistema de gobierno hidráulico y el de emergencia, ¿cómo podemos gobernar?',
        enunciado_eu: '',
        opciones_json: [
    ...
    },
    {
        ...
        category: 'Emergencias',
        puntos: 1,
        enunciado_es: '¿Cuál es la forma más efectiva de dar remolque con mal tiempo?',
        enunciado_eu: '',
        opciones_json: [
    ...
    },
    {
        ...
        category: 'Emergencias',
        puntos: 1,
        enunciado_es: 'Antes de abandonar el barco en una balsa salvavidas, debemos:',
        enunciado_eu: '',
        opciones_json: [
    ...
    },
    {
        ...
        opciones_json: [
            ...
            { id: 'b', texto: 'La zona y distancia donde el viento sopla en la misma dirección y fuerza generando olas' },
    ...
    // 10. Teoría de la Navegación (7)
    {
        ...
        enunciado_eu: '',
        opciones_json: [
            { id: 'a', texto: 'El arco de ecuador contado desde el meridiano de Greenwich' },
            { id: 'b', texto: 'El arco de meridiano contado desde el ecuador hasta el punto' },
    ...
    },
    {
        ...
        opciones_json: [
            ...
            { id: 'b', texto: 'El ángulo entre el Norte Magnético y el Norte de Aguja' },
    ...
    },
    {
        ...
        enunciado_eu: '',
        opciones_json: [
            { id: 'a', texto: 'La unión visual de dos objetos en una misma línea de posición' },
    ...
    // 11. Carta de Navegación (7)
    {
        ...
        puntos: 1,
        enunciado_es: 'Si navegamos al Rumbo Verdadero 090º y tenemos un viento del Norte que nos abate 10º, ¿cuál es el Rumbo de Superficie?',
        enunciado_eu: '',
        opciones_json: [
            { id: 'a', texto: '080º' },
            { id: 'b', texto: '100º' },
    ...
    },
    {
        ...
        category: 'Carta de Navegación',
        puntos: 1,
        enunciado_es: 'Dada una declinación magnética de 2º NW y un desvío de 4º NE. ¿Cuál es la Corrección Total?',
        enunciado_eu: '',
        opciones_json: [
            { id: 'a', texto: '+2º' },
            { id: 'b', texto: '-2º' },
    ...
    },
    {
        ...
        category: 'Carta de Navegación',
        puntos: 1,
        enunciado_es: 'Si tomamos simultáneamente demora a un faro A y distancia al mismo faro A, obtenemos:',
        enunciado_eu: '',
        opciones_json: [
    ...
    },
    {
        ...
        category: 'Carta de Navegación',
        puntos: 1,
        enunciado_es: 'Si navegamos con Rv = 045º durante 2 horas a una velocidad de 10 nudos, ¿qué distancia hemos recorrido?',
        enunciado_eu: '',
        opciones_json: [
    ...
    },
    {
        ...
        category: 'Carta de Navegación',
        puntos: 1,
        enunciado_es: 'En la carta del Estrecho de Gibraltar, ¿dónde se miden las distancias?',
        enunciado_eu: '',
        opciones_json: [
