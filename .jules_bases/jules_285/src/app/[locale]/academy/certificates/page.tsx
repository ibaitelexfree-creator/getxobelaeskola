        ...
        async function fetchCerts() {
            try {
                ...
                if (data.certificados) {
                    ...
                    if (data.certificados.length > 0 && data.certificados[0].perfil?.full_name) {
                ...
                <div className="container mx-auto px-6 py-12">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
                        <div>
                            ...
                            <h1 className="text-4xl font-display italic text-white">Tus Certificaciones</h1>
                            <p className="text-white/60">Acreditaciones oficiales obtenidas en Getxo Bela Eskola.</p>
                        </div>
                        <div className="flex items-center gap-4">
                            <div className="text-right">
                                <div className="text-xs uppercase tracking-widest text-white/40 mb-1">Total Obtenidos</div>
                                <div className="text-3xl font-display text-accent">{certificados.length}</div>
                            </div>
            ...
            <div className="container mx-auto px-6 py-16">
                {certificados.length === 0 ? (
                    <div className="max-w-xl mx-auto text-center py-20 bg-white/5 border border-dashed border-white/10 rounded-3xl">
                        ...
                        <h2 className="text-2xl font-display italic mb-4">Todavía no has obtenido certificados</h2>
                        <p className="text-white/40 mb-8">
                            Para obtener tu primera certificación, completa un curso con una nota mínima del 75%.
                        </p>
                        <Link
