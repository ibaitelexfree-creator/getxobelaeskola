...
export const convertDistance = (
	...
	switch (from) {
		case "feet":
			inMeters = value * FEET_TO_METERS;
			break;
		case "nautical_miles":
			inMeters = value * NAUTICAL_MILE_TO_KM * 1000;
			break;
		case "km":
			inMeters = value * 1000;
			break;
		case "fathoms":
			inMeters = value * FATHOM_TO_METERS;
			break;
	}
	...
	switch (to) {
		case "feet":
			return inMeters / FEET_TO_METERS;
		case "nautical_miles":
			return inMeters / (NAUTICAL_MILE_TO_KM * 1000);
		case "km":
			return inMeters / 1000;
		case "fathoms":
			return inMeters / FATHOM_TO_METERS;
		case "meters":
			return inMeters;
	}
	return inMeters;
...
export const convertPressure = (
	...
	if ((from === "hpa" && to === "mb") || (from === "mb" && to === "hpa"))
		return value;
