...
export const KNOTS_DATA: Knot[] = [
    {
        id: 'nudo-llano',
        name: 'Nudo Llano',
        description: 'Usado para unir dos cabos de la misma mena. No es seguro si hay mucha tensión o si los cabos son de diferente grosor.',
        difficulty: 'facil',
        category: 'union',
        steps: [
            { description: 'Cruza el cabo izquierdo sobre el derecho.' },
            { description: 'Pasa el cabo izquierdo por debajo del derecho (forma un medio nudo).' },
            { description: 'Ahora cruza el cabo derecho (que viene de la izquierda) sobre el izquierdo.' },
    ...
    },
    {
        id: 'as-de-guia',
        name: 'As de Guía',
        description: 'El nudo más importante. Forma una gaza fija que no se corre ni se aprieta bajo carga. Fácil de deshacer.',
        difficulty: 'facil',
        category: 'basico',
        steps: [
            { description: 'Haz un pequeño bucle (el "lago") con el chicote por encima del firme.' },
            ...
            { description: 'Sujeta el chicote y el firme del bucle, y tira del firme principal para azocar.' }
        ]
    },
    {
        id: 'ballestrinque',
        name: 'Ballestrinque',
        description: 'Nudo rápido para sujetar un cabo a un poste o barra. Ideal para defensas.',
        difficulty: 'medio',
        category: 'amarre',
        steps: [
            { description: 'Da una vuelta alrededor del poste con el chicote sobre el firme.' },
    ...
    },
    {
        id: 'ocho',
        name: 'Nudo en Ocho',
        description: 'Nudo de tope para evitar que un cabo se escape por una polea o roldana.',
        difficulty: 'facil',
        category: 'tope',
        steps: [
