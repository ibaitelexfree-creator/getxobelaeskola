...
export const TIDES_LESSON_DATA: TideLesson = {
	...
	description:
		"Comprende los fenómenos de las mareas en la Bahía del Abra, incluyendo definiciones clave, fuerzas generadoras y la Regla de los Duodécimos para el cálculo de alturas.",
	sections: [
		{
			id: "intro",
...
Total: 12/12 (la amplitud completa).`,
		},
		{
			...
			content:
				"Utiliza esta herramienta interactiva para estimar la altura de la marea en una hora específica basándote en los datos de la Pleamar y Bajamar del día.",
