...
export const ACADEMY_MODULES = [
    {
        ...
        description: 'Aprende las partes del barco (proa, popa, babor, estribor), dimensiones y elementos estructurales.',
        keywords: ['partes', 'barco', 'proa', 'popa', 'babor', 'estribor', 'casco', 'estructura']
    },
    {
        id: 'wind-lab',
        title: 'Laboratorio de Viento',
        path: '/academy/wind-lab',
        description: 'Visualiza y entiende el viento real y el viento aparente. Aprende cómo afecta a la navegación.',
        keywords: ['viento', 'real', 'aparente', 'rachas', 'dirección', 'intensidad']
    },
    {
        id: 'simulador',
        title: 'Simulador de Vela',
        path: '/academy/simulador',
        description: 'Practica las maniobras de vela en un entorno seguro y controlado.',
        keywords: ['simulador', 'práctica', 'maniobra', 'timón', 'virar', 'trasluchar']
    },
    {
        id: 'exploration',
        title: 'Exploración y Constelaciones',
        path: '/academy/exploration',
        description: 'Descubre la historia de las regatas y aprende a navegar por las estrellas (constelaciones).',
        keywords: ['historia', 'estrellas', 'constelaciones', 'navegación astronómica', 'regatas']
    },
    {
        id: 'logbook',
        title: 'Cuaderno de Bitácora (Logbook)',
        path: '/academy/logbook',
        description: 'Registra tus horas de navegación, sube tus tracks GPX y analiza tu progreso.',
    ...
    },
    {
        ...
        description: 'Aprende las maniobras fundamentales: virada, trasluchada, atraque y desatraque.',
    ...
    },
    {
        ...
        description: 'Normas de seguridad, equipo obligatorio y procedimientos de emergencia.',
        keywords: ['seguridad', 'chaleco', 'bengalas', 'emergencia', 'hombre al agua']
    }
];

export function getSystemPrompt(): string {
    // 1. Construct Nomenclature Context
    const nomenclatureContext = NAUTICAL_TERMS.map((term: NomenclatureCard) =>
    ...
    const modulesContext = ACADEMY_MODULES.map(mod =>
