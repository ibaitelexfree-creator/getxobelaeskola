...
export const BOAT_PARTS: BoatPart[] = [
	...
	},
	{
		...
		category: "structure",
		function:
			"Definir el costado izquierdo para la navegación y reglas de paso.",
		quiz: {
	...
	},
	{
		...
		category: "structure",
		function:
			"Definir el costado derecho; los barcos amurados a estribor tienen preferencia.",
		quiz: {
	...
	},
	{
		...
		name: "Quilla",
		definition:
			"Pieza estructural inferior que da estabilidad y evita la deriva lateral.",
		category: "structure",
		...
		quiz: {
			...
			options: [
				...
				"El abatimiento (deriva lateral)",
				"Que se rompa el mástil",
			],
			answer: 1,
		},
	},
	{
		...
		category: "structure",
		function:
			"Controlar el rumbo de la embarcación desviando el flujo de agua.",
		quiz: {
	...
	},
	{
		...
		category: "structure",
		function:
			"Proteger el interior y servir de superficie de trabajo para la tripulación.",
		quiz: {
	...
	},
	{
		...
		name: "Botavara",
		definition:
			"Palo horizontal articulado al mástil que sostiene el pujamen de la vela mayor.",
		category: "rigging",
	...
	},
	{
		...
		name: "Obenques",
		definition:
			"Cables laterales que sujetan el mástil para que no caiga a los lados.",
		category: "rigging",
		function: "Sujetar el mástil lateralmente.",
		quiz: {
			question: "¿Qué evitan los obenques?",
			options: [
				"Que el mástil caiga a proa",
				"Que el mástil caiga a los lados",
	...
	},
	{
		...
		name: "Estay de Proa",
		definition:
			"Cable que sujeta el mástil desde proa y donde se izan los foques o génovas.",
		category: "rigging",
		function:
			"Sujetar el mástil longitudinalmente (hacia proa) y portar velas de proa.",
		quiz: {
	...
	},
	{
		...
		category: "deck",
		function:
			"Controlar el ángulo de la vela respecto al viento (cazar o amollar).",
		quiz: {
	...
	},
	{
		...
		name: "Contra (Vang)",
		definition:
			"Sistema que tira de la botavara hacia abajo para aplanar la vela mayor.",
		category: "deck",
