...
FENÓMENOS SIGNIFICATIVOS: Ninguno.`,
		questions: [
			...
			},
			{
				...
				options: [
					...
					{
						id: "coastal",
						text: "Navegación costera directa aprovechando el térmico.",
					},
				],
			},
		],
		...
		explanation:
			"Las condiciones son ideales (Fuerza 3-4 es viento fresco pero manejable, Marejadilla es cómodo). Al ser verano y tener componente NE, es probable que se refiera a un régimen de brisas térmicas que favorecen la navegación costera. 'Todo el trapo' es adecuado para fuerza 3-4 en ceñida para un velero estándar.",
	},
	{
		id: "scenario-002",
		...
		questions: [
			{
				...
				options: [
					{
						id: "yes",
						text: "Sí, el viento de SW es favorable para ir al norte.",
					},
					{ id: "wait", text: "No, mejor esperar a que pase el frente." },
					{
						id: "short",
						text: "Sí, pero solo una vuelta corta cerca del puerto.",
					},
				],
			},
			{
				...
				options: [
					{
						id: "sails_down",
						text: "Arriar velas, asegurar todo y preparar motor/tormentín.",
					},
					{
						id: "continue",
						text: "Mantener rumbo y velocidad para escapar del frente.",
					},
				],
			},
		],
		...
		questions: [
			{
				...
				options: [
					{
						id: "yes",
						text: "Sí, no hay viento, el mar estará como un plato.",
					},
					{
						id: "no",
						text: "No, el mar de fondo de 4-5m es peligroso, especialmente en barras y bajos.",
					},
				],
			},
			{
				...
				options: [
					...
					{
						id: "swell",
						text: "Serán ondas largas y tendidas (Swell), incómodas por la falta de viento para estabilizar el barco con las velas.",
					},
				],
			},
		],
