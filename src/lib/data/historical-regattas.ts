...
export const HISTORICAL_REGATTAS: HistoricalRegatta[] = [
	{
		...
		fullDescription:
			'La regata original que dio nombre al trofeo más antiguo del deporte internacional. La goleta "America" del New York Yacht Club venció a 15 yates del Royal Yacht Squadron en una vuelta a la Isla de Wight.',
		year: 1851,
		...
		steps: [
			{
				...
				weather: {
					...
					seaState: "Calma",
					temperature: 18,
					description: "Brisa suave del oeste",
				},
				distanceFromStart: 0,
			},
			{
				id: 2,
				name: "Nab Tower",
				coordinates: [50.6667, -0.95],
				date: "22 Ago 1851, 11:30",
				description:
					"Virada en la boya oriental. El America empieza a ganar posiciones.",
				weather: {
					windSpeed: 12,
					windDirection: "SW",
					seaState: "Leve",
					temperature: 19,
					description: "El viento refresca",
				},
			...
			},
			{
				...
				description:
					"Paso por el sur de la isla. El America lidera con ventaja.",
				weather: {
					windSpeed: 15,
					windDirection: "SW",
					seaState: "Moderada",
					temperature: 20,
					description: "Mar picada en la punta sur",
				},
			...
			},
			{
				...
				description:
					"Los famosos farallones. La reina Victoria observa desde la costa.",
				weather: {
					windSpeed: 10,
					windDirection: "W",
					seaState: "Calma",
					temperature: 19,
					description: "Viento cayendo",
				},
			...
			},
			{
				...
				description:
					'Victoria histórica. "¿Quién es el segundo?", preguntó la Reina. "No hay segundo, Majestad".',
				weather: {
					windSpeed: 6,
					windDirection: "NW",
					seaState: "Plana",
					temperature: 17,
					description: "Atardecer tranquilo",
				},
	...
	},
	{
		...
		title: "Vendée Globe",
		shortDescription:
			"La vuelta al mundo en solitario, sin escalas y sin asistencia.",
		fullDescription:
			'Considerada el "Everest de los mares", esta regata pone a prueba los límites humanos y tecnológicos. Los IMOCA 60 vuelan sobre el agua gracias a sus foils.',
		year: 2024,
		...
		steps: [
			...
			},
			{
				...
				weather: {
					...
					seaState: "Tormenta",
					temperature: 5,
					description: "Condiciones extremas",
				},
			...
			},
			{
				...
				weather: {
					...
					seaState: "Tormenta",
					temperature: 4,
					description: "Vientos huracanados",
				},
			...
			},
			{
				...
				weather: {
					...
					seaState: "Moderada",
					temperature: 10,
					description: "Recepción triunfal",
				},
	...
	},
	{
		...
		fullDescription:
			"Francis Joyon y su tripulación batieron el récord en 2017 con el trimarán IDEC Sport, completando la vuelta en 40 días, 23 horas y 30 minutos.",
		year: 2017,
		...
		steps: [
			{
				...
				date: "Day 0",
				description:
					"Cruce de la línea imaginaria entre Ushant y Lizard Point.",
				weather: {
					windSpeed: 25,
					windDirection: "N",
					seaState: "Agitada",
					temperature: 11,
					description: "Viento fuerte favorable",
				},
				distanceFromStart: 0,
			},
			{
				...
				weather: {
					...
					seaState: "Moderada",
					temperature: 28,
					description: "Alisios constantes",
				},
				distanceFromStart: 3000,
			},
			{
				...
				weather: {
					...
					seaState: "Gruesa",
					temperature: 15,
					description: "Surfeando olas gigantes",
				},
			...
			},
			{
				...
				date: "Day 26",
				description:
					"Vuelta al Atlántico con una ventaja enorme sobre el récord anterior.",
				weather: {
					windSpeed: 35,
					windDirection: "W",
					seaState: "Muy Gruesa",
					temperature: 6,
					description: "Frío y velocidad",
				},
	...
	},
	{
		...
		fullDescription:
			"628 millas náuticas desde el puerto de Sydney hasta Hobart, Tasmania. Famosa por sus condiciones meteorológicas impredecibles y a menudo brutales en el Estrecho de Bass.",
		year: 1998,
		location: "Australia",
		boatStats: {
			name: "Sayonara",
		...
		steps: [
			...
			},
			{
				...
				date: "27 Dic, 18:00",
				description:
					"Entrada en el notorio estrecho. Las condiciones empeoran rápidamente.",
				weather: {
					windSpeed: 45,
					windDirection: "SW",
					seaState: "Tormenta",
					temperature: 15,
					description: "La tormenta del 98",
				},
			...
			},
			{
				...
				weather: {
					...
					seaState: "Gruesa",
					temperature: 12,
					description: "Vientos fuertes del sur",
				},
	...
	},
	{
		...
		fullDescription:
			"Desde Cowes hasta la roca Fastnet en Irlanda y vuelta a Plymouth (o Cherburgo en ediciones recientes). Una prueba táctica y de resistencia.",
		year: 1979,
	...
	},
	{
		...
		fullDescription:
			"Anteriormente Whitbread Round the World Race. Equipos profesionales compiten en etapas alrededor del planeta, enfrentándose a las peores condiciones del océano.",
		year: 2018,
		...
		steps: [
			...
			},
			{
				...
				weather: {
					...
					seaState: "Moderada",
					temperature: 20,
					description: "Vientos fuertes al llegar",
				},
				distanceFromStart: 6500,
			},
			{
				...
				weather: {
					...
					seaState: "Gruesa",
					temperature: 10,
					description: "Rugientes Cuarenta",
				},
	...
	},
	{
		...
		fullDescription:
			"Una regata iniciática para los grandes navegantes. Cruzar el Atlántico en un barco minúsculo sin asistencia ni comunicación por satélite.",
		year: 2021,
		...
		steps: [
			...
			},
			{
				...
				weather: {
					...
					seaState: "Leve",
					temperature: 24,
					description: "Alisios comenzando",
				},
			...
			},
			{
				...
				weather: {
					...
					seaState: "Moderada",
					temperature: 28,
					description: "Alisios establecidos",
				},
	...
	},
	{
		...
		fullDescription:
			"Cada 4 años, los barcos más rápidos del mundo (Ultim, IMOCA, Class40) compiten en esta ruta histórica del ron.",
		year: 2022,
		...
		steps: [
			{
				...
				weather: {
					...
					seaState: "Agitada",
					temperature: 12,
					description: "Frentes atlánticos",
				},
				distanceFromStart: 0,
			},
			{
	...
	},
	{
		...
		fullDescription:
			"La primera regata de vuelta al mundo a dos, saliendo y llegando a Barcelona, cruzando el Estrecho de Gibraltar.",
		year: 2011,
		...
		steps: [
			...
			},
			{
				...
				weather: {
					...
					seaState: "Agitada",
					temperature: 15,
					description: "Corrientes fuertes",
				},
			...
			},
			{
				...
				weather: {
					...
					seaState: "Leve",
					temperature: 18,
					description: "Primavera mediterránea",
				},
	...
	},
	{
		...
		fullDescription:
			"La regata pionera que lo empezó todo. Una aventura peligrosa donde los navegantes eran exploradores.",
		year: 1973,
		...
		steps: [
			...
			},
			{
				...
				weather: {
					...
					seaState: "Moderada",
					temperature: 14,
					description: "Bienvenida heroica",
				},
