...
describe('Auth Guard', () => {
    ...
    describe('requireAdmin', () => {
        ...
        it('should succeed if user is admin', async () => {
            ...
            expect(result.error).toBeNull(); // Changed from toBeUndefined to toBeNull because implementation returns null explicitly
            expect(result.user).toEqual(user);
            expect(result.profile).toEqual(profile);
        });
    });
    ...
    describe('requireInstructor', () => {
        ...
        it('should succeed if user is instructor', async () => {
            ...
            expect(result.error).toBeNull(); // Changed from toBeUndefined to toBeNull
            expect(result.user).toEqual(user);
        });
