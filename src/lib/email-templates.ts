...
const translations = {
	es: {
		...
		welcome_p1:
			"Es un auténtico placer darte la bienvenida a nuestra tripulación. Has dado el primer paso oficial para convertirte en un experto navegante con la <strong>Getxo Sailing School</strong>.",
		welcome_p2:
		...
		contact_footer:
			"Este es un mensaje automático generado por el sistema de gestión de Getxo Sailing School.",
	},
	en: {
		welcome_title: "Welcome aboard, {name}! ⛵",
		welcome_p1:
			"It is a real pleasure to welcome you to our crew. You have taken the first official step to becoming an expert sailor with <strong>Getxo Sailing School</strong>.",
		welcome_p2:
		...
		contact_footer:
			"This is an automatic message generated by the Getxo Sailing School management system.",
	},
	fr: {
		welcome_title: "Bienvenue à bord, {name} ! ⛵",
		welcome_p1:
			"C'est un réel plaisir de vous accueillir dans notre équipage. Vous avez fait le premier pas officiel pour devenir un marin expert avec la <strong>Getxo Sailing School</strong>.",
		welcome_p2:
		...
		contact_footer:
			"Ceci est un message automatique généré par le système de gestion de Getxo Sailing School.",
	},
	eu: {
