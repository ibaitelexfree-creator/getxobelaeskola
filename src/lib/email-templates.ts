...
const translations = {
	es: {
		...
		welcome_p1:
			"Es un auténtico placer darte la bienvenida a nuestra tripulación. Has dado el primer paso oficial para convertirte en un experto navegante con la <strong>Getxo Getxo Bela Eskola</strong>.",
		welcome_p2:
			"Tu cuenta ha sido creada con éxito. Ya puedes acceder a nuestra Academia Online para empezar a explorar los cursos, niveles y material teórico disponible.",
		welcome_button: "IR A LA ACADEMIA",
		welcome_footer:
			"¿Tienes alguna duda inicial? Estamos aquí para ayudarte. Simplemente responde a este correo o visítanos en el puerto.",
		welcome_signoff: "Viento en popa y buena travesía.",
		inscription_title: "Confirmación de Inscripción ⚓",
		inscription_p1: "Hola {name},",
		inscription_p2:
			"Tu inscripción al curso <strong>{courseName}</strong> ha sido procesada correctamente. ¡Ya formas parte de esta nueva promoción!",
		inscription_selected: "Curso seleccionado",
		inscription_p3:
			"Estamos preparando todo para tu formación. En los próximos días recibirás más detalles sobre el calendario de sesiones prácticas y el material necesario.",
		inscription_p4:
			"Puedes empezar a revisar el contenido teórico ya mismo desde tu área personal.",
		...
		certificate_p2:
			"Has completado satisfactoriamente toda la formación de <strong>{courseName}</strong>.",
		certificate_p3:
			"Este es un gran hito en tu carrera náutica. Ya puedes descargar tu certificado oficial en formato digital desde tu perfil.",
		certificate_button: "DESCARGAR DIPLOMA",
		certificate_p4:
			"Tu esfuerzo tiene recompensa. ¡Sigue navegando hacia tus metas!",
		rental_title: "Confirmación de Alquiler ⛵",
		rental_p1: "Hola {name},",
		rental_p2:
			"Tu reserva de <strong>{serviceName}</strong> ha sido confirmada y el equipo estará listo para ti.",
		rental_item: "Material / Barco",
		rental_date: "Fecha",
		rental_time: "Hora de Inicio",
		rental_important: "Información Importante:",
		rental_note1:
			"Por favor, llega al Puerto Deportivo 15 minutos antes de la hora acordada.",
		rental_note2:
			"No olvides traer calzado adecuado (suela blanca o náuticos) y protección solar.",
		rental_note3:
			"La actividad está sujeta a las condiciones meteorológicas por seguridad.",
		...
		membership_p2:
			"Es un orgullo para nosotros que pases a formar parte de nuestra comunidad de socios. A partir de ahora tienes acceso a todos los privilegios exclusivos:",
		...
		membership_footer:
			"¡Gracias por confiar en nosotros para tu aventura náutica!",
		footer_copy: "&copy; {year} <strong>Getxo Getxo Bela Eskola</strong>",
		footer_address: "Puerto Deportivo de Getxo, Bizkaia.",
		footer_unsubscribe:
			"Estás recibiendo este correo porque has realizado una actividad con nosotros. Si no deseas recibir más correos, puedes gestionar tus preferencias en tu perfil.",
		contact_title: "Nuevo Mensaje de Contacto ⚓",
		contact_p1:
			"Se ha recibido una nueva consulta desde el formulario de la web.",
		contact_from: "De:",
		contact_phone: "Teléfono:",
		contact_subject: "Asunto:",
		contact_button: "RESPONDER DIRECTAMENTE",
		contact_footer:
			"Este es un mensaje automático generado por el sistema de gestión de Getxo Getxo Bela Eskola.",
	},
	en: {
		welcome_title: "Welcome aboard, {name}! ⛵",
		welcome_p1:
			"It is a real pleasure to welcome you to our crew. You have taken the first official step to becoming an expert sailor with <strong>Getxo Getxo Bela Eskola</strong>.",
		welcome_p2:
			"Your account has been successfully created. You can now access our Online Academy to start exploring the courses, levels, and theoretical material available.",
		welcome_button: "GO TO THE ACADEMY",
		welcome_footer:
			"Do you have any initial questions? We are here to help. Simply reply to this email or visit us at the port.",
		welcome_signoff: "Fair winds and following seas.",
		inscription_title: "Enrollment Confirmation ⚓",
		inscription_p1: "Hello {name},",
		inscription_p2:
			"Your enrollment in the course <strong>{courseName}</strong> has been successfully processed. You are now part of this new promotion!",
		inscription_selected: "Selected course",
		inscription_p3:
			"We are preparing everything for your training. In the coming days, you will receive more details about the schedule of practical sessions and the necessary material.",
		inscription_p4:
			"You can start reviewing the theoretical content right now from your personal area.",
		...
		certificate_p2:
			"You have successfully completed all the training for <strong>{courseName}</strong>.",
		certificate_p3:
			"This is a great milestone in your nautical career. You can now download your official digital certificate from your profile.",
		certificate_button: "DOWNLOAD DIPLOMA",
		certificate_p4:
			"Your effort has its reward. Keep sailing towards your goals!",
		rental_title: "Rental Confirmation ⛵",
		rental_p1: "Hello {name},",
		rental_p2:
			"Your reservation for <strong>{serviceName}</strong> has been confirmed, and the team will be ready for you.",
		rental_item: "Equipment / Boat",
		rental_date: "Date",
		rental_time: "Start Time",
		rental_important: "Important Information:",
		rental_note1:
			"Please arrive at the Marina 15 minutes before the agreed time.",
		rental_note2:
			"Don't forget to bring suitable footwear (white soles or deck shoes) and sunscreen.",
		...
		membership_p2:
			"We are proud to have you as part of our community of members. You now have access to all exclusive privileges:",
		...
		membership_p3:
			"You can already see your updated member status in your profile.",
		...
		footer_unsubscribe:
			"You are receiving this email because you have performed an activity with us. If you do not wish to receive more emails, you can manage your preferences in your profile.",
		...
		contact_footer:
			"This is an automatic message generated by the Getxo Getxo Bela Eskola management system.",
	},
	fr: {
		welcome_title: "Bienvenue à bord, {name} ! ⛵",
		welcome_p1:
			"C'est un réel plaisir de vous accueillir dans notre équipage. Vous avez fait le premier pas officiel pour devenir un marin expert avec la <strong>Getxo Getxo Bela Eskola</strong>.",
		welcome_p2:
			"Votre compte a été créé avec succès. Vous pouvez désormais accéder à notre Académie en ligne pour commencer à explorer les cours, les niveaux et le matériel théorique disponible.",
		welcome_button: "ALLER À L'ACADÉMIE",
		welcome_footer:
			"Avez-vous des questions initiales ? Nous sommes là pour vous aider. Répondez simplement à cet e-mail ou rendez-nous visite au port.",
		welcome_signoff: "Bon vent et bonne navigation.",
		inscription_title: "Confirmation d'inscription ⚓",
		inscription_p1: "Bonjour {name},",
		inscription_p2:
			"Votre inscription au cours <strong>{courseName}</strong> a été traitée avec succès. Vous faites désormais partie de cette nouvelle promotion !",
		inscription_selected: "Cours sélectionné",
		inscription_p3:
			"Nous préparons tout pour votre formation. Dans les prochains jours, vous recevrez plus de détails sur le calendrier des sessions pratiques et le matériel nécessaire.",
		inscription_p4:
			"Vous pouvez commencer à réviser le contenu théorique dès maintenant depuis votre espace personnel.",
		...
		certificate_p2:
			"Vous avez terminé avec succès toute la formation de <strong>{courseName}</strong>.",
		certificate_p3:
			"C'est une étape importante dans votre carrière nautique. Vous pouvez désormais télécharger votre certificat numérique officiel depuis votre profil.",
		certificate_button: "TÉLÉCHARGER LE DIPLÔME",
		certificate_p4:
			"Votre effort est récompensé. Continuez à naviguer vers vos objectifs !",
		rental_title: "Confirmation de location ⛵",
		rental_p1: "Bonjour {name},",
		rental_p2:
			"Votre réservation de <strong>{serviceName}</strong> a été confirmée et l'équipe sera prête pour vous.",
		rental_item: "Matériel / Bateau",
		rental_date: "Date",
		rental_time: "Heure de début",
		rental_important: "Informations importantes :",
		rental_note1:
			"Veuillez arriver au port de plaisance 15 minutes avant l'heure convenue.",
		rental_note2:
			"N'oubliez pas d'apporter des chaussures adaptées (semelles blanches ou chaussures de pont) et de la crème solaire.",
		rental_note3:
			"L'activité est soumise aux conditions météorologiques pour votre sécurité.",
		rental_button: "VOIR MES RÉSERVATIONS",
		rental_footer: "Bonne navigation !",
		membership_title:
			"Vous êtes maintenant membre de Getxo Getxo Bela Eskola ! 🎖️",
		membership_p1: "Bonjour {name},",
		membership_p2:
			"Nous sommes fiers de vous compter parmi notre communauté de membres. Vous avez désormais accès à tous les privilèges exclusifs :",
		...
		membership_p3:
			"Vous pouvez déjà voir votre statut de membre mis à jour dans votre profil.",
		membership_button: "ALLER À MON ESPACE MEMBRE",
		membership_footer:
			"Merci de nous faire confiance pour votre aventure nautique !",
		footer_copy: "&copy; {year} <strong>Getxo Getxo Bela Eskola</strong>",
		footer_address: "Port de plaisance de Getxo, Biscaye.",
		footer_unsubscribe:
			"Vous recevez cet e-mail parce que vous avez effectué une activité avec nous. Si vous ne souhaitez plus recevoir d'e-mails, vous pouvez gérer vos préférences dans votre profil.",
		contact_title: "Nouveau message de contact ⚓",
		contact_p1:
			"Une nouvelle demande a été reçue via le formulaire du site web.",
		contact_from: "De :",
		contact_phone: "Téléphone :",
		contact_subject: "Sujet :",
		contact_button: "RÉPONDRE DIRECTEMENT",
		contact_footer:
			"Ceci est un message automatique généré par le système de gestion de Getxo Getxo Bela Eskola.",
	},
	eu: {
		welcome_title: "Ongi etorri ontziratuta, {name}! ⛵",
		welcome_p1:
			"Plazer handia da gure eskifaira ongi etorria ematea. Getxo Bela Eskolarekin nabigatzaile aditua izateko lehen urrats ofiziala eman duzu.",
		welcome_p2:
			"Zure kontua ondo sortu da. Dagoeneko gure Online Akademian sar zaitezke ikastaroak, mailak eta eskuragarri dagoen material teorikoa arakatzen hasteko.",
		welcome_button: "JOAN AKADEMIARA",
		welcome_footer:
			"Hasierako zalantzarik al duzu? Hemen gaude laguntzeko. Mezua erantzun besterik ez duzu edo etorri portura.",
		welcome_signoff: "Haize on eta nabigazio ona.",
		inscription_title: "Izen-ematearen Baieztapena ⚓",
		inscription_p1: "Kaixo {name},",
		inscription_p2:
			"Zure izen-ematea <strong>{courseName}</strong> ikastaroan ondo prozesatu da. Dagoeneko promozio berri honen parte zara!",
		inscription_selected: "Hautatutako ikastaroa",
		inscription_p3:
			"Dena prestatzen ari gara zure prestakuntzarako. Hurrengo egunetan saio praktikoen egutegiari eta beharrezko materialari buruzko xehetasun gehiago jasoko dituzu.",
		inscription_p4:
			"Dagoeneko eduki teorikoa berrikusten has zaitezke zure eremu pertsonaletik.",
		...
		certificate_p2:
			"<strong>{courseName}</strong> prestakuntza guztia ondo osatu duzu.",
		certificate_p3:
			"Mugarri handia da hau zure itsas ibilbidean. Dagoeneko zure ziurtagiri ofiziala formatu digitalean deskarga dezakezu zure profiletik.",
		certificate_button: "DESKARGATU DIPLOMA",
		certificate_p4:
			"Zure ahaleginak saria du. Jarraitu zure helburuetara nabigatzen!",
		rental_title: "Alokairuaren Baieztapena ⛵",
		rental_p1: "Kaixo {name},",
		rental_p2:
			"Zure <strong>{serviceName}</strong> erreserba baieztatu da eta taldea prest egongo da zuretzat.",
		rental_item: "Materiala / Ontzia",
		rental_date: "Data",
		rental_time: "Hasiera Ordua",
		rental_important: "Informazio Garrantzitsua:",
		rental_note1:
			"Mesedez, iritsi Getxoko Kirol Portura adostutako ordua baino 15 minutu lehenago.",
		rental_note2:
			"Ez ahaztu oinetako egokiak (zola zuria edo nautikoak) eta eguzki-babesa ekartea.",
		rental_note3:
			"Segurtasunagatik, jarduera baldintza meteorologikoen mende dago.",
		...
		membership_p2:
			"Harrotasuna da guretzat gure bazkide komunitatearen parte izatea. Hemendik aurrera pribilegio esklusibo guztietarako sarbidea duzu:",
		...
		membership_item3:
			"Lehentasunezko sarbidea eskolako ekitaldi eta estropadetara.",
		membership_item4: "Instalazioak eta aldagelak erabiltzeko aukera.",
		membership_p3:
			"Dagoeneko ikus dezakezu zure bazkide egoera eguneratuta zure profilean.",
		membership_button: "JOAN NIRE BAZKIDE EREMURA",
		membership_footer:
			"Eskerrik asko guregan konfiantza izateagatik zure itsas abenturarako!",
		footer_copy: "&copy; {year} <strong>Getxo Bela Eskola</strong>",
		footer_address: "Getxoko Kirol Portua, Bizkaia.",
		footer_unsubscribe:
			"Mezu hau jasotzen ari zara gurekin jardueraren bat egin duzulako. Mezu gehiago jaso nahi ez baduzu, zure hobespenak kudea ditzakezu zure profilean.",
		...
		contact_footer:
			"Hau Getxo Bela Eskolako kudeaketa sistemak sortutako mezu automatikoa da.",
	},
};
...
export const certificateTemplate = (
	...
	const t = translations[locale] || translations.es;
	const downloadUrl = certificateId
		? `${BASE_URL}/academy/certificates/${certificateId}`
		: `${BASE_URL}/student/dashboard/certificates`;
 ...
 */
export const internalOrderNotificationTemplate = (
	type: "rental" | "course" | "membership",
	details: any,
) =>
	baseLayout(
		`
