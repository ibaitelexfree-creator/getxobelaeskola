...
export const generateCertificatePDF = async (
	...
	doc.setTextColor(secondaryColor);
	doc.setFontSize(14);
	doc.text("Ha completado satisfactoriamente el curso", centerX, 105, {
		align: "center",
	});
	...
	doc.setFontSize(10);
	doc.text("Director Académico", centerX - 50, signatureY + 5, {
		align: "center",
	});
	doc.setFontSize(8);
	doc.setTextColor(secondaryColor);
	doc.text("Getxo Bela Eskola", centerX - 50, signatureY + 9, {
		align: "center",
	});
	...
	doc.setFontSize(10);
	doc.setTextColor(0);
	doc.text("Instructor Jefe", centerX + 50, signatureY + 5, {
		align: "center",
	});
	doc.setFontSize(8);
	doc.setTextColor(secondaryColor);
	doc.text("Departamento de Vela", centerX + 50, signatureY + 9, {
		align: "center",
	});
