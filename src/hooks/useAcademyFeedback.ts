...
export function useAcademyFeedback() {
	...
	const showAchievement = (
		...
		addNotification({
			...
			message:
				locale === "eu" && achievement.descripcion_eu
					? achievement.descripcion_eu
					: achievement.descripcion_es,
	...
	const checkForNewAchievements = async () => {
		try {
			...
			const _unlocked = newAchievements.filter((a) => !prevIds.includes(a.id));
