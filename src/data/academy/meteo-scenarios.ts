...
export const METEO_SCENARIOS: MeteoScenario[] = [
	{
		...
		context:
			"Estás navegando a 2 millas de la costa de Getxo. Es una tarde calurosa de verano. Tienes planeado ir hasta Castro Urdiales (10 millas al oeste).",
		meteoReport: {
			date: "15 Agosto, 16:00 HL",
			location: "Aguas Costeras de Bizkaia",
			synopsis:
				"Baja térmica formándose en el interior. Descenso rápido de presión (4hPa en última hora).",
		...
		explanation:
			"La caída brusca de presión y el aviso de Galerna indican un cambio violento de viento a NW con rachas muy fuertes (fuerza 8 o más). La seguridad prima: debes regresar a puerto inmediatamente antes de que llegue el frente de racha. Intentar llegar a Castro te expondría a vientos muy fuertes y mar cruzada peligrosa.",
	},
	{
		id: "travesia-hendaya",
		title: "Travesía a Hendaya",
		context:
			"Plan de fin de semana: Navegar desde Getxo hasta Hendaya (aprox. 35 millas al este). Barco: Velero 35 pies.",
		meteoReport: {
			date: "10 Septiembre, 09:00 HL",
			location: "Costa Vasca",
			synopsis:
				"Anticiclón estable sobre las Azores extendiéndose hacia el Golfo de Vizcaya.",
			wind: "Noroeste (NW) fuerza 3 a 4. Rachas de 15 nudos.",
			seaState:
				"Marejadilla con áreas de marejada al final del día. Mar de fondo del NW de 1 metro.",
		...
		explanation:
			"Fuerza 3-4 es ideal para navegar a vela. Un NW te permitirá hacer un rumbo directo o con pocos bordos hacia el Este (través/aleta). Mantenerse a 2-3 millas evita los rebotes de ola en los acantilados y da margen de seguridad. La configuración vélica estándar es adecuada.",
	},
	{
		id: "niebla-matinal",
		title: "Salida de Pesca con Niebla",
		context:
			"Amanecer de otoño. Tienes planeado salir a pescar bonitos a 12 millas de la costa.",
		meteoReport: {
		...
		explanation:
			"Con visibilidad inferior a 200m, el riesgo de colisión es altísimo, especialmente con pesqueros o mercantes que frecuentan la zona. Si no tienes radar y experiencia avanzada, la decisión correcta es esperar (la niebla suele levantar a mediodía). Si tuvieras que navegar por fuerza mayor, sería a motor, con luces, señales fónicas y radar.",
	},
];
