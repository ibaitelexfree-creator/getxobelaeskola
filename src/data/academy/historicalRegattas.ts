...
const ROUTES = {
    americasCup: [
        [41.3851, 2.1734], [41.3800, 2.1800], [41.3750, 2.1750], [41.3820, 2.1650], [41.3851, 2.1734]
    ] as [number, number][],
    velux5Oceans: [
        [46.1603, -1.1511], [-33.9249, 18.4241], [-31.9505, 115.8605], [-55.9798, -67.2768], [46.1603, -1.1511]
    ] as [number, number][],
    julesVerne: [
        [48.3904, -4.4861], [0, -20], [-34, 18], [-46, 50], [-46, 115], [-56, -67], [0, -30], [48.3904, -4.4861]
    ] as [number, number][],
    volvoOcean: [
        [38.3452, -0.4810], [-33.9249, 18.4241], [22.3193, 114.1694], [-36.8485, 174.7633], [-22.9068, -43.1729], [41.5268, -71.2829], [51.4545, -3.1629], [52.0705, 4.3007]
    ] as [number, number][],
    vendeeGlobe: [
        [46.4967, -1.7853], [0, -25], [-40, 20], [-50, 120], [-56, -67], [0, -35], [46.4967, -1.7853]
    ] as [number, number][],
    sydneyHobart: [
        [-33.8688, 151.2093], [-35.0, 151.0], [-37.0, 150.5], [-40.0, 149.0], [-42.8821, 147.3272]
    ] as [number, number][],
    fastnet: [
        [50.7600, -1.3000], [50.0, -3.0], [49.8, -5.0], [51.3, -9.6], [49.8, -5.5], [49.6, -1.6]
    ] as [number, number][],
    transpac: [
        [33.7405, -118.2786], [30.0, -130.0], [25.0, -145.0], [21.3069, -157.8583]
    ] as [number, number][],
    routeRhum: [
        [48.6493, -2.0257], [45.0, -10.0], [30.0, -30.0], [20.0, -50.0], [16.2650, -61.5510]
    ] as [number, number][],
    goldenGlobe: [
        [50.1527, -5.0527], [0, -20], [-34, 18], [-46, 115], [-56, -67], [0, -30], [50.1527, -5.0527]
    ] as [number, number][]
};
