...
const ROUTES = {
	americasCup: [
		...
		[41.375, 2.175],
		[41.382, 2.165],
		[41.3851, 2.1734], // Barcelona Course
	],
	velux5Oceans: [
		[46.1603, -1.1511],
		[-33.9249, 18.4241],
		[-31.9505, 115.8605],
		[-55.9798, -67.2768],
		[46.1603, -1.1511], // La Rochelle -> Cape Town -> Fremantle -> Horn -> La Rochelle
	],
	julesVerne: [
		[48.3904, -4.4861],
		[0, -20],
		...
		[-56, -67],
		[0, -30],
		[48.3904, -4.4861], // Brest -> Equator -> Good Hope -> Leeuwin -> Horn -> Equator -> Brest
	],
	volvoOcean: [
		[38.3452, -0.481],
		[-33.9249, 18.4241],
		...
		[41.5268, -71.2829],
		[51.4545, -3.1629],
		[52.0705, 4.3007], // Alicante -> CT -> HK -> Auckland -> Itajai -> Newport -> Cardiff -> The Hague
	],
	vendeeGlobe: [
		[46.4967, -1.7853],
		[0, -25],
		...
		[-56, -67],
		[0, -35],
		[46.4967, -1.7853], // Les Sables -> ... -> Les Sables
	],
	sydneyHobart: [
		[-33.8688, 151.2093],
		[-35.0, 151.0],
		[-37.0, 150.5],
		[-40.0, 149.0],
		[-42.8821, 147.3272], // Sydney -> Hobart
	],
	fastnet: [
		[50.76, -1.3],
		[50.0, -3.0],
		...
		[51.3, -9.6],
		[49.8, -5.5],
		[49.6, -1.6], // Cowes -> Fastnet Rock -> Cherbourg
	],
	transpac: [
		[33.7405, -118.2786],
		[30.0, -130.0],
		[25.0, -145.0],
		[21.3069, -157.8583], // LA -> Honolulu
	],
	routeRhum: [
		[48.6493, -2.0257],
		[45.0, -10.0],
		[30.0, -30.0],
		[20.0, -50.0],
		[16.265, -61.551], // St Malo -> Guadeloupe
	],
	goldenGlobe: [
		[50.1527, -5.0527],
		[0, -20],
		...
		[-56, -67],
		[0, -30],
		[50.1527, -5.0527], // Falmouth -> ... -> Falmouth
	],
};
...
export const HISTORICAL_REGATTAS: Regatta[] = [
	{
		...
		name: "Copa América",
		description:
			"El trofeo más antiguo del deporte internacional. Una competición de match race donde la tecnología y la velocidad son protagonistas.",
		boatStats: {
			length: 22.9,
			crew: 8,
			speedRecord: 53.3,
			type: "AC75 Foiling Monohull",
		},
	...
	},
	{
		...
		name: "Velux 5 Oceans",
		description:
			"La vuelta al mundo en solitario con escalas. Una prueba de resistencia extrema para el patrón y el barco.",
	...
	},
	{
		...
		description:
			"El desafío definitivo: vuelta al mundo a vela sin escalas ni asistencia en el menor tiempo posible.",
	...
	},
	{
		...
		name: "The Ocean Race",
		description:
			"La vuelta al mundo por equipos más dura. Visita los lugares más remotos y peligrosos del planeta.",
	...
	},
	{
		...
		name: "Vendée Globe",
		description:
			"El Everest de los mares: vuelta al mundo en solitario, sin escalas y sin asistencia.",
	...
	},
	{
		...
		name: "Sydney Hobart",
		description:
			"Una de las regatas oceánicas más difíciles del mundo, famosa por sus condiciones meteorológicas impredecibles.",
	...
	},
	{
		...
		description:
			"Una clásica regata offshore de 600 millas que pone a prueba la estrategia y la navegación táctica.",
	...
	},
	{
		...
		name: "Transpac",
		description:
			"Desde Los Ángeles hasta Honolulu, una regata famosa por sus vientos alisios y largas planeadas.",
	...
	},
	{
		...
		name: "Route du Rhum",
		description:
			"Transatlántica en solitario desde Francia hasta Guadalupe. Un sprint oceánico de alto nivel.",
	...
	},
	{
		...
		description:
			"Una vuelta al pasado: navegación sin tecnología moderna, recreando la histórica regata de 1968.",
		boatStats: {
			length: 11,
			crew: 1,
			speedRecord: 8,
			type: "Rustler 36 (Vintage)",
		},
