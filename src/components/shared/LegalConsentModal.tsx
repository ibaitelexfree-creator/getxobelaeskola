...
export default function LegalConsentModal({
	...
	const documents = [
		{
			name: "Formulario Inscripción a cursos",
			path: "/Documentos/Formularios inscripcion, LOPD y normas a firmar al contratar servicioos/Formulario Inscripción a cursos.pdf",
		},
		{
			name: "Formulario Inscripción Socios",
			path: "/Documentos/Formularios inscripcion, LOPD y normas a firmar al contratar servicioos/Formulario Inscripción Socias.pdf",
		},
		{
			name: "Formulario Inscripción Equipos",
			path: "/Documentos/Formularios inscripcion, LOPD y normas a firmar al contratar servicioos/Formulario Inscripción Equipos de entrenamiento.pdf",
		},
		{
			name: "Normas y LOPD Udalekus",
			path: "/Documentos/Formularios inscripcion, LOPD y normas a firmar al contratar servicioos/Formulario Inscripción Udalekus.pdf",
		},
	];
								...
								<div className="grid md:grid-cols-2 gap-6 pt-4 border-t border-white/5">
									...
									<div className="space-y-2">
										...
										<div className="flex gap-2">
											...
											>
												<option value="DNI" className="bg-nautical-black">
													DNI
												</option>
												<option value="NIE" className="bg-nautical-black">
													NIE
												</option>
												<option value="PASPORT" className="bg-nautical-black">
													Pasaporte
												</option>
											</select>
											<input
												...
												onBlur={() => {
													if (dni) {
														...
														if (!validation.isValid) {
															setDniError(
																validation.message || tV("email_invalid"),
															);
														}
													}
												}}
