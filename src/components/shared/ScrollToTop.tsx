...
export default function ScrollToTop() {
	...
	return (
		<button
			onClick={scrollToTop}
			className={`fixed bottom-32 md:bottom-8 right-8 z-[9999] p-3 rounded-full bg-accent text-nautical-black shadow-lg shadow-accent/20 transition-all duration-500 hover:scale-110 hover:-translate-y-1 group ${
				isVisible && !isExternallyHidden
