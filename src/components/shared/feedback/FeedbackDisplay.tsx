...
import { MessageSquare, Pause, Play, Volume2 } from "lucide-react";
							...
							<div className="flex-1 space-y-2">
								...
								{item.audio_url && (
									<div className="mt-3 flex items-center gap-3">
										<audio
											controls
											className="h-8 w-full max-w-[200px] rounded-full opacity-60 hover:opacity-100 transition-opacity"
										>
