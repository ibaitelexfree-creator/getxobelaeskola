...
describe('ThemeToggle', () => {
    ...
    it('should show correct icon for light theme', () => {
        (useThemeStore as any).mockReturnValue({ theme: 'light', setTheme: mockSetTheme });
        render(<ThemeToggle />);
    ...
    it('should show correct icon for dark theme', () => {
        (useThemeStore as any).mockReturnValue({ theme: 'dark', setTheme: mockSetTheme });
        render(<ThemeToggle />);
    ...
    it('should cycle through themes correctly', () => {
        ...
        // System -> Light
        (useThemeStore as any).mockReturnValue({ theme: 'system', setTheme: mockSetTheme });
        rerender(<ThemeToggle />);
        fireEvent.click(screen.getByRole('button', { name: /Toggle theme/i }));
