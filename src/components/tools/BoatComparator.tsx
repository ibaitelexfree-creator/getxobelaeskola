...
const BOATS: Boat[] = [
	{
		...
		description:
			"El barco ideal para la iniciación de los más pequeños. Estable y seguro.",
	},
	{
		id: "laser",
		name: "Laser (ILCA 7)",
		...
		description:
			"Monoplaza olímpico de gran popularidad. Requiere buena forma física y técnica.",
	},
	{
		id: "j80",
		name: "J80",
		...
		description:
			"Barco de regata muy rápido y divertido, ideal para aprender navegación en equipo.",
	},
	{
		id: "bavaria30",
		name: "Bavaria 30",
		...
		description:
			"Crucero cómodo y seguro para travesías familiares o con amigos.",
	},
];
			...
			{selectedBoats.length > 0 ? (
						...
						<table className="w-full text-left border-collapse">
							<thead>
								<tr className="bg-gray-50 border-b border-gray-200">
									<th className="p-4 font-semibold text-gray-600 w-1/4">
										Especificación
									</th>
									{selectedBoats.map((boat) => (
										<th
											key={boat.id}
											className="p-4 font-bold text-gray-900 min-w-[150px]"
										>
											{boat.name}
										</th>
									))}
							...
							<tbody className="divide-y divide-gray-100">
								<tr>
									<td className="p-4 text-gray-600 font-medium bg-gray-50/50">
										Eslora
									</td>
									{selectedBoats.map((boat) => (
								...
								<tr>
									...
									{selectedBoats.map((boat) => (
										<td
											key={boat.id}
											className="p-4 text-gray-800 font-semibold text-green-700"
										>
											{boat.specs.price}
										</td>
									))}
				...
				<div className="text-center py-12 bg-white rounded-lg border border-dashed border-gray-300">
					<p className="text-gray-500">
						Selecciona al menos una embarcación para ver la tabla comparativa.
					</p>
				</div>
			)}
		</div>
