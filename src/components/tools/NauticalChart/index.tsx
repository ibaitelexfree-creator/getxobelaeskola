...
const NauticalMap = dynamic(() => import("./Map"), {
	ssr: false,
	loading: () => (
		<div className="w-full h-full bg-slate-100 flex items-center justify-center text-slate-400 font-mono text-sm tracking-widest uppercase animate-pulse">
	...
	return (
		<div className="w-full flex flex-col gap-6">
			<div className="flex flex-col gap-2">
				<h1 className="text-3xl md:text-4xl font-display italic text-nautical-blue">
					{t("title")}
				</h1>
				<p className="text-slate-500 font-light tracking-wide text-sm md:text-base max-w-2xl">
					{t("subtitle")}
				</p>
			</div>
