...
const styles = StyleSheet.create({
  ...
  cornerTL: { position: 'absolute', top: 0, left: 0, width: 15, height: 15, backgroundColor: '#ca8a04' },
  cornerTR: { position: 'absolute', top: 0, right: 0, width: 15, height: 15, backgroundColor: '#ca8a04' },
  cornerBL: { position: 'absolute', bottom: 0, left: 0, width: 15, height: 15, backgroundColor: '#ca8a04' },
  cornerBR: { position: 'absolute', bottom: 0, right: 0, width: 15, height: 15, backgroundColor: '#ca8a04' },
                ...
                <View style={styles.borderContainer}>
                    <View style={styles.innerBorder}>
                        ...
                        <View style={styles.signaturesContainer}>
                            ...
                            <View style={styles.signatureBox}>
                                <Text style={styles.pseudoSignature}>{data.instructorName || 'Instructor Jefe'}</Text>
                                <View style={styles.signatureLine} />
