...
describe('CertificateCard', () => {
    ...
    it('should render certificate info correctly', () => {
        render(<CertificateCard certificate={mockCertificate} studentName="Juan Perez" locale="es" />);
    ...
    it('should show level name for level type certificates', () => {
        ...
        render(<CertificateCard certificate={levelCert} studentName="Juan Perez" locale="eu" />);
    ...
    it('should show error alert if PDF generation fails', async () => {
        ...
        await waitFor(() => {
            expect(alert).toHaveBeenCalledWith('Error al generar el certificado. Inténtalo de nuevo.');
        });
    });
});
