...
export default function Flashcard({
	...
	const enunciado =
		locale === "eu" ? pregunta.enunciado_eu : pregunta.enunciado_es;
	const explicacion =
		locale === "eu" ? pregunta.explicacion_eu : pregunta.explicacion_es;
		...
		>
			...
			>
				...
				>
					...
					<h3 className="text-xl font-display text-white mb-2 leading-relaxed">
						{enunciado}
					</h3>
