...
export const RegattaGame = () => {
	...
	const { opponents, matchStatus, isConnected, broadcastState } =
		useRegattaSocket(matchId, userId, null);
	...
	if (!userId) {
		return (
			<div className="text-white text-center mt-20">Cargando usuario...</div>
		);
	}
	...
	return (
		<div className="relative w-full h-screen bg-black">
			...
			<SailingSimulator onStateUpdate={broadcastState} opponents={opponents} />
		</div>
	);
};
