...
export default function MistakeReviewDeck({
	initialMistakes,
	locale,
}: MistakeReviewDeckProps) {
		...
		return (
			<div className="flex flex-col items-center justify-center py-20 text-center">
				...
				<p className="text-white/60 mb-8 max-w-md">
					Has repasado tus dudas pendientes. ¡Gran trabajo, Capitán!
				</p>
				<button
					onClick={() =>
						(window.location.href = `/${locale}/academy/dashboard`)
					}
	...
	return (
		<div className="max-w-md mx-auto w-full">
			<div className="mb-6 flex justify-between items-center text-xs uppercase tracking-widest text-white/40">
				<span>
					Duda {currentIndex + 1} de {mistakes.length}
				</span>
