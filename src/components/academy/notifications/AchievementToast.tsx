...
function Toast({ notification, index, onDismiss }: ToastProps) {
	...
	const rarityColors: Record<string, string> = {
		legendario:
			"from-yellow-500/20 to-orange-500/20 border-yellow-400/50 shadow-[0_0_30px_rgba(234,179,8,0.3)]",
		epico:
			"from-emerald-500/20 to-teal-500/20 border-emerald-400/50 shadow-[0_0_30px_rgba(16,185,129,0.3)]",
