...
function SkillModal({ notification, onClose }: SkillModalProps) {
    ...
    return (
        <>
            {/* Backdrop */}
            <div
                className={`fixed inset-0 bg-black/80 backdrop-blur-sm z-[100] transition-opacity duration-500 ${isVisible ? 'opacity-100' : 'opacity-0'
                    }`}
                onClick={onClose}
            />
            ...
            >
                ...
                >
                    ...
                    <div className="relative text-center space-y-6">
                        ...
                        {/* Title */}
                        <h2 id="skill-modal-title" className="text-4xl font-display italic text-white leading-tight">
                            {notification.title}
                        </h2>
