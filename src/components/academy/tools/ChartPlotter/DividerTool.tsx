...
export default function DividerTool({
	...
	const _handleDragEndP1 = (_e: any, info: any) =>
		setP1((p) => ({ x: p.x + info.offset.x, y: p.y + info.offset.y }));
	const _handleDragEndP2 = (_e: any, info: any) =>
		setP2((p) => ({ x: p.x + info.offset.x, y: p.y + info.offset.y }));
