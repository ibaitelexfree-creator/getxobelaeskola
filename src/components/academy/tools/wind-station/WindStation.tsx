...
import { Battery, Compass, Wifi, Wind } from "lucide-react";
...
export default function WindStation() {
	...
	}, [fetchHistory, supabase.channel, supabase.removeChannel]);
						...
						<>
							...
							<div className="grid grid-cols-2 gap-4 w-full">
								...
								<div className="bg-white/5 rounded-xl p-4 text-center border border-white/5">
									...
									<span className="text-2xl font-mono text-amber-400 tabular-nums">
