...
import {
	FLASHCARDS_DATA,
	type FlashcardData,
} from "@/lib/academy/flashcards-data";
...
export default function FlashcardGame() {
	...
	const [filter, setFilter] = useState<"all" | "luces" | "banderas" | "nudos">(
		"all",
	);
	...
	if (finished) {
		return (
			<div className="flex flex-col items-center justify-center py-12 animate-fade-in">
				<h2 className="text-4xl font-display italic text-white mb-6">
					¡Sesión Completada!
				</h2>
				...
				<div className="flex gap-8 mb-8">
					<div className="text-center">
						...
						<div className="text-3xs uppercase tracking-widest text-white/40">
							Aciertos
						</div>
					</div>
					<div className="text-center">
	...
	return (
		<div className="max-w-4xl mx-auto">
			...
			<div className="flex flex-col items-center gap-8">
				...
				{/* Response Buttons */}
				<div
					className={`flex gap-4 transition-opacity duration-500 ${isFlipped ? "opacity-100" : "opacity-0 pointer-events-none"}`}
				>
					<button
