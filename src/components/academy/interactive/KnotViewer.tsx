...
import { Knot } from '@/lib/academy/knots-data';
            ...
            <div className="flex-1 bg-gradient-to-br from-nautical-black to-[#1a2c42] relative min-h-[300px] flex items-center justify-center p-8">
                ...
                <div className="text-center">
                    <div className="w-48 h-48 rounded-full border-4 border-white/10 flex items-center justify-center bg-white/5 mb-6 mx-auto relative group cursor-pointer hover:scale-105 transition-transform">
                        ...
                        <span className="text-8xl font-black text-white/5 select-none">{currentStep + 1}</span>
            ...
            <div className="w-full md:w-80 bg-white/5 border-t md:border-t-0 md:border-l border-white/10 p-8 flex flex-col justify-between">
                <div>
                    <div className="flex items-center justify-between mb-4">
                        <h3 className="text-2xl font-display italic text-white">{knot.name}</h3>
                        <span className={`text-3xs font-black uppercase px-2 py-1 rounded bg-white/10 ${knot.difficulty === 'facil' ? 'text-green-400' :
                                knot.difficulty === 'medio' ? 'text-yellow-400' : 'text-red-400'
                            }`}>
                            {knot.difficulty}
                        </span>
                    </div>
                    ...
                    <div className="bg-nautical-black/50 p-4 rounded-lg border border-white/5 min-h-[100px]">
                        <h4 className="text-accent text-2xs font-bold uppercase tracking-widest mb-2">Instrucción:</h4>
                ...
                <div className="flex items-center justify-between mt-8 gap-4">
                    ...
                    >
                        ...
                        {currentStep < knot.steps.length - 1 && <ChevronRight className="w-4 h-4" />}
                    </button>
                </div>
            </div>
        </div>
