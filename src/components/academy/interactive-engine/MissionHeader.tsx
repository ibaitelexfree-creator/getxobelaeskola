...
export const MissionHeader: React.FC<Props> = ({ title, timerSeconds }) => {
    const { status, score, currentStep, totalSteps, failMission } = useMissionStore();
        ...
        <div className="relative px-6 py-4 border-b border-white/10 bg-nautical-black/40 backdrop-blur-md flex items-center justify-between overflow-hidden">
            ...
            <div className="flex items-center gap-4 relative z-10">
                <div className="flex flex-col">
                    <span className="text-3xs uppercase tracking-[0.2em] text-accent font-black mb-0.5">Misión Activa</span>
            ...
            <div className="flex items-center gap-6 relative z-10">
                ...
                <div className="text-right hidden sm:block">
                    <span className="text-3xs uppercase tracking-widest text-white/40 block mb-1">Puntuación</span>
                    <motion.span
                        key={score}
                ...
                {timerSeconds > 0 && (
                    <div className="flex flex-col items-end">
                        <span className={`text-3xs uppercase tracking-widest block mb-1 ${isUrgent ? 'text-red-400' : 'text-white/40'}`}>
                            Tiempo
                        </span>
                        <motion.div
