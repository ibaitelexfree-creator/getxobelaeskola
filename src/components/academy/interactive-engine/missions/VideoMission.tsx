...
import type { MissionData, VideoCheckpoint, VideoMissionData } from "../types";
...
export const VideoMission: React.FC<VideoMissionProps> = ({
	data,
	onComplete,
}) => {
	...
	}, [videoUrl, extractYouTubeId, initPlayer]);
	...
	}, [isYouTube, ytPlayer, checkCheckpoints]);
	...
	if (error) {
		return (
			<div className="p-4 text-red-400 border border-red-500/20 bg-red-900/10 rounded-lg">
				{error}
			</div>
		);
	}
