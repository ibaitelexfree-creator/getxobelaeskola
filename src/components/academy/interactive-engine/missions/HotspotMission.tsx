...
export const HotspotMission: React.FC<Props> = ({ data }) => (
    <div className="text-center p-8 bg-cyan-900/10 rounded-lg border border-cyan-500/20">
        <h4 className="text-xl font-display text-cyan-300 mb-4">Identificación Visual</h4>
        <p className="text-cyan-100/60 mb-6">{data.descripcion || 'Selecciona las zonas correctas en la imagen.'}</p>
        <div className="w-full h-64 bg-black/40 rounded flex items-center justify-center relative border border-white/10">
            <span className="text-white/20 text-sm font-mono">[ IMAGEN REQUERIDA ]</span>
