    ...
    useEffect(() => {
        ...
        const initMap = async () => {
            ...
            if (mapRef.current && !mapInstanceRef.current) {
                ...
                // Club Marker
                L.marker(CLUB_LOCATION).addTo(map)
                ...
                L.polygon(DANGER_ZONE, {
                    ...
                    fillOpacity: 0.2,
                    weight: 2
                }).addTo(map).bindPopup('Zona Peligrosa: Bajos');

                // Waypoints
                const waypoints = [
                    { pos: [43.352, -3.030], title: "Salida del Puerto", desc: "Canal de navegación principal." },
                    { pos: [43.360, -3.050], title: "Boyas de Regata", desc: "Zona habitual de entrenamiento." },
                    { pos: [43.356, -3.033], title: "Bajos de Arrigunaga", desc: "Peligro: Rocas sumergidas." }
                ];

                waypoints.forEach(wp => {
                    L.marker(wp.pos as [number, number]).addTo(map)
