...
export const HoloDashboard: React.FC<HoloDashboardProps> = ({
	state,
	physics,
}) => {
	...
	const _isLaminar = isMainEfficient && isJibEfficient;

	return (
		<div className="grid grid-cols-2 gap-x-8 gap-y-6 w-full px-2">
			{/* Wind Speed */}
			<div className="flex flex-col">
				<span className="text-[10px] md:text-xs font-bold text-slate-400 tracking-widest uppercase mb-1">
					WIND SPEED:
				</span>
			...
			<div className="flex flex-col">
				<span className="text-[10px] md:text-xs font-bold text-slate-400 tracking-widest uppercase mb-1">
					{t("telemetry.boat_speed").toUpperCase()}:
				</span>
				<div className="flex items-baseline gap-2">
					<span className="text-2xl md:text-3xl font-mono font-medium text-cyan-300 drop-shadow-[0_0_8px_rgba(34,211,238,0.5)]">
			...
			<div className="flex flex-col">
				<span className="text-[10px] md:text-xs font-bold text-slate-400 tracking-widest uppercase mb-1">
					{t("telemetry.efficiency").toUpperCase()}:
				</span>
				<div className="flex items-baseline gap-2">
					<span className="text-2xl md:text-3xl font-mono font-medium text-cyan-300 drop-shadow-[0_0_8px_rgba(34,211,238,0.5)]">
			...
			<div className="flex flex-col">
				<span className="text-[10px] md:text-xs font-bold text-slate-400 tracking-widest uppercase mb-1">
					{t("telemetry.heel_angle").toUpperCase()}:
				</span>
				<div className="flex items-baseline gap-2">
					<span className="text-2xl md:text-3xl font-mono font-medium text-cyan-300 drop-shadow-[0_0_8px_rgba(34,211,238,0.5)]">
...
const _StatusTag = ({
	...
	<div
		className={`flex items-center gap-1.5 px-2 py-0.5 rounded-full text-3xs font-black tracking-widest transition-opacity duration-300 ${active ? "opacity-100" : "opacity-10"}`}
	>
