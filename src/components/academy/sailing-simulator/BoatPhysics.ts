...
export class BoatPhysics {
	...
	public update(
		...
		let polarFactor = 0;
		if (windAngleRelBow < 0.52)
			polarFactor = -0.5; // Drag/Baking in Irons
		else if (windAngleRelBow < 1.0)
			polarFactor = 1.0; // Close Haul
		else if (windAngleRelBow < 2.0)
			polarFactor = 1.5; // Beam/Broad Reach (Fastest)
