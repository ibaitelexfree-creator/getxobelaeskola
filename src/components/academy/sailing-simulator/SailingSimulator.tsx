...
import type { OpponentState } from "../../../types/regatta";
 ...
 */
export const SailingSimulator: React.FC<SailingSimulatorProps> = ({
	onStateUpdate,
	opponents,
	mode,
	lobbyCode,
	...
	const [gameOverData, setGameOverData] = React.useState<{
		score: number;
		leaderboard: any[];
	}>({ score: 0, leaderboard: [] });
	...
	const currentRank = React.useMemo(() => {
		...
		const tempBoard = [
			...
			{ name: "YOU", score: gameOverData.score },
		].sort((a, b) => b.score - a.score);
