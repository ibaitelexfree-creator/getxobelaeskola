...
export class WakeManager {
	...
	public update(dt: number, state: BoatState) {
		...
		if (this.distanceAccumulator >= spawnDistance && speed > 0.1) {
			const numParticlesToSpawn = Math.floor(
