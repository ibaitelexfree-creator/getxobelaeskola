...
const COSMOS_DATA: ConstellationNode[] = [
	{
		...
		type: "star",
		status: "completed",
		description: "El inicio de todo marinero.",
		link: "/academy/course/iniciacion-j80",
	},
	{
		id: "2",
		label: "Nudos",
		...
		type: "star",
		status: "available",
		description: "El arte de la cabuyería.",
	...
	},
	{
		...
		type: "planet",
		status: "available",
		description: "Entendiendo el cielo y el mar.",
	...
	},
	{
		...
		type: "star",
		status: "available",
		description: "Primero, sobrevivir.",
		link: "/academy/skills",
	},
	{
		id: "5",
		...
		type: "nebula",
		status: "available",
		description: "Arte de ir de A a B.",
		link: "/academy/tools/chart-plotter",
	},
	{
		id: "6",
		...
		type: "planet",
		status: "available",
		description: "Conoce tu embarcación.",
		link: "/academy/tools/nomenclature",
	},
	{
		id: "7",
		label: "Cuaderno",
		...
		type: "star",
		status: "available",
		description: "Tu viaje personal.",
		link: "/academy/logbook",
	},
	{
		id: "8",
		label: "Grandes Regatas",
		x: 700,
		y: 150,
		type: "nebula",
		status: "available",
		description: "Revive la historia de la navegación.",
		link: "/academy/exploration/regattas",
	},
];
	...
	return (
		<div className="w-full h-full bg-[#000510] relative overflow-hidden font-display select-none touch-none">
			...
			<div
				...
				style={{ background: "url(/images/stars-bg.svg) repeat" }}
			/>
				...
				{COSMOS_DATA.map((node) => (
					...
					>
						...
						<circle
							cx={node.x}
							cy={node.y}
							r={node.type === "planet" ? 25 : 15}
							fill="transparent"
							stroke={node.status === "completed" ? "#4ade80" : "#fbbf24"}
							strokeWidth="1"
							strokeOpacity="0.5"
						/>
						<circle
							cx={node.x}
							cy={node.y}
							r={node.type === "planet" ? 8 : 5}
							fill={node.status === "completed" ? "#4ade80" : "#fbbf24"}
						/>
						<text
							x={node.x}
							y={node.y + 40}
			...
			{activeNode && (
				...
				>
					...
					<h3
						id="node-title"
						className="text-2xl text-accent font-display mb-3"
					>
						{activeNode.label}
					</h3>
					<p
					...
					{activeNode.link ? (
						...
						<span className="text-2xs text-white/30 uppercase tracking-widest">
							Próximamente
						</span>
					)}
				</div>
