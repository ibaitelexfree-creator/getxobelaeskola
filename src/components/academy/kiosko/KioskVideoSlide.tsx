		...
		<div className="w-full h-full flex items-center justify-center bg-black relative">
			...
			<div className="absolute bottom-20 left-12 bg-black/40 backdrop-blur-md p-8 rounded-3xl border border-white/10 max-w-xl">
				...
				<p className="text-white/80 text-2xl font-light">
					Escuela de Vela y Club Náutico Getxo
				</p>
				<div className="mt-4 flex gap-4">
					<span className="px-4 py-2 bg-accent text-nautical-black font-bold uppercase tracking-widest text-xs rounded-full">
						Cursos Disponibles
					</span>
					<span className="px-4 py-2 bg-white/20 text-white font-bold uppercase tracking-widest text-xs rounded-full">
