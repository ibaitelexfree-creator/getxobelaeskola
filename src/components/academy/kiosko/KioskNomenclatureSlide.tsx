...
export default function KioskNomenclatureSlide({ locale }: KioskNomenclatureSlideProps) {
    ...
    return (
        <div className="w-full h-full flex flex-col items-center justify-center bg-nautical-black relative p-12 overflow-hidden">
            ...
            <div className="relative w-full h-full flex items-center justify-center z-10" style={{ perspective: '1500px' }}>
