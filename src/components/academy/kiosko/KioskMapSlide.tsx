...
const LeafletMap = dynamic(() => import('@/components/academy/dashboard/LeafletMap'), {
    ssr: false,
    loading: () => <div className="w-full h-full bg-nautical-black animate-pulse flex items-center justify-center text-white/20">Cargando Mapa...</div>
});
...
const MOCK_SESSIONS = [
    {
        ...
        track_log: [
            ...
            { lat: 43.340, lng: -3.018 },
            { lat: 43.330, lng: -3.020 }, // Puente
            { lat: 43.325, lng: -3.018 },
            { lat: 43.320, lng: -3.015 },
        ]
    },
    {
        id: 'route-2',
        ubicacion: { lat: 43.360, lng: -3.050 },
        zona_nombre: 'Salida al Abra Exterior',
        track_log: [
            { lat: 43.345, lng: -3.015 },
            { lat: 43.355, lng: -3.030 },
            { lat: 43.365, lng: -3.060 },
            { lat: 43.370, lng: -3.080 },
            { lat: 43.375, lng: -3.090 },
        ]
    }
];
    ...
    return (
        <div className="w-full h-full relative bg-nautical-black">
            ...
            <div className="absolute top-12 left-12 z-[1000] bg-nautical-black/80 backdrop-blur-md p-8 rounded-3xl border border-white/10 shadow-2xl">
                 ...
                 <p className="text-accent text-sm uppercase tracking-[0.2em] font-bold">Explora el Abra y la Ría de Bilbao</p>
