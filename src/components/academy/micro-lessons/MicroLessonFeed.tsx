...
export default function MicroLessonFeed({ isOpen, initialLessonId, onClose }: MicroLessonFeedProps) {
    ...
    useEffect(() => {
        if (isOpen && initialLessonId && containerRef.current) {
            ...
            setTimeout(() => {
                const el = containerRef.current?.querySelector(`[data-id="${initialLessonId}"]`);
                if (el) {
