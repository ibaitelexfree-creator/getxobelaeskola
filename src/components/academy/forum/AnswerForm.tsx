...
export default function AnswerForm({ preguntaId, onSuccess, onCancel }: AnswerFormProps) {
    ...
    return (
        <form onSubmit={handleSubmit} className="mt-8 animate-fade-in bg-white/[0.02] p-6 rounded-lg border border-white/5">
            <h4 className="text-sm uppercase tracking-widest text-white/70 font-bold mb-4">Tu Respuesta</h4>
