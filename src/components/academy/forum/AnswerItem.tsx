...
export default function AnswerItem({ answer, isStaff, onMarkCorrect }: AnswerItemProps) {
    return (
        <div className={`p-4 md:p-6 rounded-lg mb-4 border transition-all duration-300 ${answer.es_correcta ? 'border-accent/40 bg-accent/[0.05]' : 'border-white/5 bg-white/[0.02] hover:bg-white/[0.04]'}`}>
            <div className="flex gap-4 md:gap-6">
                ...
                <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col">
                                <span className="text-sm font-bold text-white/90 truncate">
                                    {answer.profiles?.nombre || 'Usuario'} {answer.profiles?.apellidos || ''}
                                </span>
                    ...
                    {isStaff && !answer.es_correcta && (
                        ...
                        >
                            <span className="w-4 h-4 rounded-full border border-white/20 group-hover:border-accent flex items-center justify-center text-transparent group-hover:text-accent transition-all">✓</span>
