...
export default function Nomenclature3DView({
	locale,
}: Nomenclature3DViewProps) {
					...
					>
						...
						<div className="mb-4">
							...
							<p className="text-sm leading-relaxed text-slate-700">
								{locale === "eu"
									? activeCard.definition_eu
									: activeCard.definition_es}
							</p>
						</div>
						...
						<div className="bg-sky-50 p-3 rounded-md border border-sky-100">
							...
							<p className="text-sm font-medium text-sky-900 italic">
								{locale === "eu"
									? activeCard.question_eu
									: activeCard.question_es}
							</p>
						</div>
					</motion.div>
				)}
