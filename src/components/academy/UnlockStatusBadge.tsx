...
import { Lock, Unlock, CheckCircle, RotateCw, Circle } from 'lucide-react';
import Link from 'next/link';

export type UnlockStatus = 'locked' | 'bloqueado' | 'available' | 'no_iniciado' | 'in_progress' | 'en_progreso' | 'completed' | 'completado';
...
export const UnlockStatusBadge: React.FC<UnlockStatusBadgeProps> = ({ status, className = '' }) => {
