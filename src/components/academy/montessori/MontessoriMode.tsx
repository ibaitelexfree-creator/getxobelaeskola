        ...
        <div className="container mx-auto px-6 py-12 min-h-screen">
             <header className="mb-12">
                ...
                <p className="text-white/60 font-light max-w-2xl leading-relaxed">
                    Navega libremente por los conceptos náuticos. El sistema adaptará las recomendaciones
                    según tu progreso y ritmo de aprendizaje.
                </p>
                ...
                <div className="mt-8 inline-flex items-center gap-4 bg-white/5 px-6 py-3 rounded-full border border-white/10">
                    <span className="text-[10px] uppercase tracking-widest text-white/40">Nivel de Habilidad</span>
                    ...
                    <span className="font-mono text-accent text-sm">{Math.round(ability * 100)}%</span>
                </div>
            </header>
