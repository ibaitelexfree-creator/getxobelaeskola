import { Check, Lock, PlayCircle, Star, Trophy } from "lucide-react";
import React from "react";
import type {
	MontessoriNode,
	UserProgress,
} from "@/lib/academy/montessori/types";
...
export default function TopicNode({
	...
	if (isCompleted) {
		...
		bgClass =
			"bg-blue-600/20 border-blue-400 text-blue-300 hover:bg-blue-600/30 cursor-pointer";
		icon = <PlayCircle className="w-5 h-5" />;
	}

	if (isRecommended) {
		bgClass =
			"bg-amber-500/20 border-amber-400 text-amber-300 shadow-[0_0_20px_rgba(245,158,11,0.3)] animate-pulse-slow cursor-pointer";
