		...
		return (
			<div className="relative w-full max-w-2xl aspect-video rounded-3xl overflow-hidden shadow-2xl border border-white/10 group">
				...
				<div className="absolute inset-0 flex flex-col items-center justify-center p-12 text-center">
					...
					<h3 className="text-2xl font-display italic text-white mb-2 tracking-wide">
						Preparando Travesía
					</h3>
					<p className="text-white/70 text-2xs uppercase tracking-[0.3em] font-black">
						Validando cartas náuticas...
					</p>
				</div>
			</div>
		);
