...
import { Anchor, Clock, Ship, Star, TrendingUp, Wind } from "lucide-react";
			...
			<section className="space-y-6">
				...
				<div className="bg-[#111827] border border-dashed border-white/10 rounded-2xl p-12 text-center">
					...
					<p className="text-white/40 text-sm italic mb-6">
						No has registrado sesiones de navegación aún.
					</p>
					<Link
						...
						<div className="relative z-10">
							<div className="flex justify-between items-start mb-4">
								...
								<div className="text-right">
									<div className="text-xl font-black text-white">
										{boat.hours}{" "}
										<span className="text-[10px] text-accent">h</span>
									</div>
									<div className="text-[9px] uppercase tracking-widest text-white/40">
										{boat.sessions} Sesiones
									</div>
								</div>
							</div>
							...
							<div className="mt-4 pt-4 border-t border-white/5 flex items-center justify-between">
								<div className="flex items-center gap-2 text-[10px] text-white/40 italic">
									<Clock size={10} />
									Última vez:{" "}
									{new Date(boat.lastUsed).toLocaleDateString("es-ES")}
								</div>
								<Link
									href={`/${locale}/academy/logbook`}
