    ...
    return (
        <div className="relative w-full h-screen overflow-hidden bg-slate-900 select-none">
            ...
            <div className="absolute inset-0 z-20 flex items-center justify-center pointer-events-none">
                ...
                <svg width="200" height="400" viewBox="0 0 100 200" className="opacity-80">
                    {/* Hull */}
                    <path d="M50,0 C80,50 80,150 50,200 C20,150 20,50 50,0 Z" fill="#334155" stroke="#94a3b8" strokeWidth="2" />
                    {/* Mast */}
