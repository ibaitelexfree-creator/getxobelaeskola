...
const CertificateDocument: React.FC<CertificateDocumentProps> = ({
    ...
    try {
        formattedDate = new Date(issueDate).toLocaleDateString('es-ES', { year: 'numeric', month: 'long', day: 'numeric' });
    } catch (e) {
    ...
    const distinctionLabel = distinction === 'excellence' ? 'EXCELENCIA ACADÉMICA' :
                             distinction === 'merit' ? 'MÉRITO DISTINGUIDO' :
                             distinction && distinction !== 'standard' ? distinction.toUpperCase() : null;
            ...
            <Page size="A4" orientation="landscape" style={styles.page}>
                <View style={styles.borderContainer}>
                    <View style={styles.innerBorder}>
                        ...
                        <Text style={styles.courseDetails}>Ha completado satisfactoriamente el curso</Text>
