...
import { Anchor, Award, ChevronRight, Map, Ship, Wind } from "lucide-react";
					...
					<AnimatePresence mode="wait">
						{step === 0 && (
							...
							>
								...
								<h2 className="text-3xl font-display text-white mb-4 italic">
								...
								<button
									onClick={nextStep}
									className="px-8 py-3 bg-accent text-nautical-black font-bold rounded hover:scale-105 transition-transform"
								>
									{t("start_btn")}
								</button>
							</motion.div>
						...
						{step === 1 && (
							<motion.div
								...
								className="flex-1"
							>
								<h3 className="text-2xl font-display text-white mb-6 italic">
									{t("step_1_title")}
								</h3>
						...
						{step === 2 && (
							...
							>
								<h3 className="text-2xl font-display text-white mb-2 italic">
									{t("step_2_title")}
								</h3>
						...
						{step === 5 && (
							...
							>
								...
								<h2 className="text-3xl font-display text-accent mb-2 italic">
									{t("congrats_title")}
								</h2>
