...
import { getTideLevel, getTidePredictions } from "@/lib/puertos-del-estado";
				...
				<div className="p-6 lg:col-span-1 space-y-4">
						...
						{predictions.map((pred, idx) => (
							...
							>
								<div className="flex items-center gap-3">
									<div
										className={`p-2 rounded-full ${pred.type === "HIGH" ? "bg-blue-500/20 text-blue-400" : "bg-orange-500/20 text-orange-400"}`}
									>
										{pred.type === "HIGH" ? (
											<ArrowUp size={16} />
										) : (
					...
					<div className="mt-6 p-4 bg-blue-900/10 rounded-lg border border-blue-500/20">
						<p className="text-[10px] text-blue-200/60 leading-relaxed">
							...
							Estos datos son una simulación educativa y no deben usarse para
							navegación real. Consulte siempre las tablas oficiales de Puertos
							del Estado.
						</p>
					</div>
				</div>
