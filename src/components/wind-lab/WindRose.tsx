		...
		<div className="w-full max-w-4xl mx-auto p-4 flex flex-col md:flex-row gap-8 items-center justify-center">
			...
			<div className="relative w-[300px] h-[300px] md:w-[400px] md:h-[400px] select-none touch-none">
				...
				>
					...
					<path
						d={`M 150 150 L ${p2c(-30, 140).x} ${p2c(-30, 140).y} A 140 140 0 0 1 ${p2c(30, 140).x} ${p2c(30, 140).y} Z`}
					...
					<line
						x1="150"
						y1="150"
						x2={p2c(bestUpwind, 140).x}
						y2={p2c(bestUpwind, 140).y}
					...
					<line
						x1="150"
						y1="150"
						x2={p2c(360 - bestUpwind, 140).x}
						y2={p2c(360 - bestUpwind, 140).y}
						stroke="rgba(34, 197, 94, 0.5)"
						strokeDasharray="4 2"
					/>
					...
					<g transform="translate(150, 150)">
						{/* Simple Boat Shape */}
						<path
							d="M 0 -20 Q 10 0 10 20 L -10 20 Q -10 0 0 -20"
							fill="#0f172a"
						/>
					</g>
				...
				<div className="space-y-4">
					...
					<div className="grid grid-cols-2 gap-4">
						...
						<div className="bg-slate-50 p-3 rounded-lg">
							...
							<div
								className={`text-xl font-bold ${vmg > 0 ? "text-green-600" : "text-orange-500"}`}
							>
								{vmg} kn
							</div>
						</div>
					...
					<div className="pt-2">
						...
						<div className="flex justify-between text-sm">
							...
							<span className="font-mono">
								{bestUpwind}° / {360 - bestUpwind}°
							</span>
						</div>
						<div className="flex justify-between text-sm mt-1">
							<span>Downwind:</span>
							<span className="font-mono">
								{bestDownwind}° / {360 - bestDownwind}°
							</span>
						</div>
					</div>
				</div>
