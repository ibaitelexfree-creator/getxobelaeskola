...
import { Anchor, ArrowRight, Clock, Users } from "lucide-react";
...
export default function RentalCard({
	...
	const getImgSrc = () => {
		...
		else if (n.includes("raquero"))
			src = "/images/course-raquero-students.webp";
		else if (n.includes("optimist") || n.includes("laser"))
			src = "/images/courses/CursodeVelaLigera.webp";

		if (
			!src ||
			src.includes("placeholder") ||
			src.includes("rental-category")
		) {
			if (service.categoria === "windsurf")
				src = "/images/courses/PerfeccionamientoVela.webp";
			else if (
				service.categoria === "paddlesurf" ||
				service.categoria === "kayak" ||
				service.categoria === "piragua"
			)
