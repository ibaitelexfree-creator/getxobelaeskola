...
import { ChevronRight, Loader2, Sparkles, X, Zap } from "lucide-react";
			...
			<div className="bg-gradient-to-b from-[#0a1628] to-nautical-black border border-white/10 w-full max-w-4xl max-h-[90vh] overflow-hidden rounded-sm flex flex-col relative shadow-2xl">
				...
				<div className="p-8 md:p-12 overflow-y-auto">
					<header className="mb-12">
						...
						<h2 className="text-4xl md:text-5xl font-display italic text-white leading-none">
							Bonos de Horas
						</h2>
						<p className="text-white/40 mt-4 max-w-xl font-light">
							Navega más por menos. Adquiere un pack de horas y úsalo de forma
							flexible en cualquier reserva de alquiler.
						</p>
					</header>
					...
					{loading ? (
						...
						<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
							{bonos.map((bono) => (
								<div
									key={bono.id}
									className="bg-white/5 border border-white/5 p-8 flex flex-col group hover:border-accent/30 transition-all hover:bg-white/[0.07]"
								>
									<div className="mb-8">
