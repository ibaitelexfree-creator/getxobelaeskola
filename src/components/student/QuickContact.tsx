...
export default function QuickContact() {
	...
	return (
		<section className="bg-card p-6 border border-card-border rounded-sm relative overflow-hidden group">
			<div className="absolute top-0 right-0 p-4 opacity-5 text-4xl pointer-events-none group-hover:scale-110 transition-transform">
				💬
			</div>
				...
				>
					...
					<div>
						...
						<p className="text-white/60 text-[10px]">
							Respuesta rápida en horario lectivo
						</p>
					</div>
				</a>
			...
			<div className="mt-6 pt-6 border-t border-white/5 flex items-center justify-between">
				<div className="flex items-center gap-2">
					...
					<span className="text-[9px] uppercase tracking-widest text-white/50 font-bold italic">
						Soporte Online
					</span>
				</div>
