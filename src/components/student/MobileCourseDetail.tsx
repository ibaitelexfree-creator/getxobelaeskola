...
import { Check, ChevronLeft, Clock, User } from "lucide-react";
		...
		<div className="pb-24 bg-nautical-black min-h-screen">
			...
			<div className="relative h-72 w-full">
				{course.imagen_url ? (
					...
					<div className="w-full h-full bg-nautical-black flex items-center justify-center text-4xl">
						⚓
					</div>
				)}
			...
			<div className="px-6 -mt-12 relative z-10">
				...
				<div className="space-y-8">
					...
					<section className="bg-white/5 border border-white/10 rounded-2xl p-6">
						<h2 className="text-lg font-display text-white mb-6">
							Próximas Fechas
						</h2>
						<BookingSelector
							editions={editions}
