	...
	return (
		<section className="animate-fade-in" style={{ animationDelay: "0.2s" }}>
			<div className="bg-gradient-to-r from-brass-gold/20 to-brass-gold/5 p-8 border border-brass-gold/30 rounded-sm relative overflow-hidden group">
				<div className="absolute top-0 right-0 p-8 opacity-10 text-9xl pointer-events-none group-hover:scale-110 transition-transform duration-700">
					⚓
				</div>

				<div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
					<div className="text-center md:text-left">
						<h3 className="text-2xl font-display italic text-white mb-2 underline decoration-brass-gold/40">
							Hazte Socio del Club
						</h3>
						<p className="text-white/70 text-sm max-w-md">
							Únete a la comunidad de navegantes de Getxo Bela. Por solo{" "}
							<span className="text-brass-gold font-bold">20€/mes</span> tendrás
							descuentos en alquileres, prioridad en cursos y eventos
							exclusivos.
						</p>
					</div>
