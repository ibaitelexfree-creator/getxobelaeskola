							...
							{filteredSessions.map((session) => (
								...
								>
									...
									<td className="p-4 text-center">
										<div
											className={`inline-flex items-center gap-1.5 px-2 py-1 rounded-sm text-xs font-medium ${session.modules_count > 0 ? "bg-blue-500/10 text-blue-400" : "text-white/20"}`}
										>
											<BookOpen size={12} />
									...
									<td className="p-4 text-center">
										<div
											className={`inline-flex items-center gap-1.5 px-2 py-1 rounded-sm text-xs font-medium ${session.questions_count > 0 ? "bg-purple-500/10 text-purple-400" : "text-white/20"}`}
										>
											<Brain size={12} />
									...
									<td className="p-4 pr-6 text-right">
										<div
											className={`inline-flex items-center gap-1.5 font-bold ${session.xp_earned > 0 ? "text-accent" : "text-white/20"}`}
										>
											{session.xp_earned > 0 && "+"}
											{session.xp_earned}
											<Trophy size={12} />
