...
vi.mock('framer-motion', () => ({
    motion: {
        div: ({ children, className, ...props }: { children: React.ReactNode, className?: string }) => <div className={className} {...props}>{children}</div>,
        span: ({ children, className, ...props }: { children: React.ReactNode, className?: string }) => <span className={className} {...props}>{children}</span>,
        p: ({ children, className, ...props }: { children: React.ReactNode, className?: string }) => <p className={className} {...props}>{children}</p>,
    },
...
describe('MobileCourseList', () => {
    ...
    it('renders fallback courses when API returns empty list', async () => {
        ...
        expect(consoleSpy).toHaveBeenCalledWith('API returned empty courses, using fallback.');
        consoleSpy.mockRestore();
    });
