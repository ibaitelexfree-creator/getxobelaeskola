	...
	return (
		...
		>
			...
			<div className="p-6 relative">
				<h3 className="text-xl font-display text-white mb-2 group-hover:text-accent transition-colors">
					{name}
				</h3>
				<p className="text-white/50 text-sm leading-relaxed line-clamp-2 mb-6 font-light">
					{desc}
				</p>
				...
				<div className="flex items-center justify-between">
					<div className="flex flex-col">
						...
						<span className="text-2xl font-bold text-white italic">
							{course.precio}
							<span className="text-accent text-sm not-italic ml-1">€</span>
						</span>
					</div>
...
const FALLBACK_COURSES: Course[] = [
	{
		...
		descripcion_es:
			"Iníciate en la navegación a vela en veleros J80. Cursos de 20 horas.",
		descripcion_eu: "Hasi nabigazioan J80 belaontzietan. 20 orduko ikastaroak.",
		precio: 150,
		imagen_url:
			"https://images.unsplash.com/photo-1544620347-c4fd4a3d5997?q=80&w=2074",
	},
	{
		id: "f2",
		...
		descripcion_eu:
			"Lortu zure titulu ofiziala egun bakar batean, azterketarik gabe.",
		precio: 149,
		imagen_url:
	...
	},
	{
		...
		descripcion_es:
			"Cursos para niños y adultos en embarcaciones individuales.",
	...
	useEffect(() => {
		async function fetchCourses() {
			try {
				...
				if (
					json.cursos &&
					Array.isArray(json.cursos) &&
					json.cursos.length > 0
				) {
						...
						<>
							<div className="flex flex-col">
								...
								<span className="text-[10px] uppercase tracking-[0.3em] text-accent font-black mt-1">
									{courses.length}{" "}
									{locale === "eu" ? "Eskuragarri" : "Disponibles"}
								</span>
							</div>
							<button
