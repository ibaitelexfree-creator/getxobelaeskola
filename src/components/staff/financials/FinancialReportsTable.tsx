...
import type { FinancialTransaction, HistoryEntry } from "./types";
						...
						<tbody className="divide-y divide-white/[0.02]">
							{transactions.length > 0 ? (
								transactions.map((item) => (
									...
									>
										...
										<td className="py-6 font-mono text-xs text-white/30">
											{item.coupons ? (
												<span
													className="text-accent border border-accent/20 px-2 py-1 rounded bg-accent/5"
													title={item.coupons.code}
												>
													{item.coupons.code}
												</span>
											) : (
										...
										<td className="py-6">
											<div className="flex items-center gap-2 group/cell">
												<span
													className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-2xs uppercase tracking-widest font-black ${
								...
								<tr>
									<td
										colSpan={6}
										className="py-12 text-center text-white/20 italic border-b border-white/5"
									>
