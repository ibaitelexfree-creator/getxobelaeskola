...
import type { ChartDataPoint, FinancialTransaction } from "./types";

interface FinancialReportsChartProps {
...
export default function FinancialReportsChart({
	chartData,
	maxChartValue,
	CHART_H,
	startDate,
	...
	return (
		<div className="glass-panel p-12 rounded-sm space-y-12">
			...
			<div className="relative h-[300px] w-full flex items-end gap-2 group/chart border-b border-white/5 pb-2">
				...
				<div className="absolute inset-0 flex flex-col justify-between pointer-events-none opacity-5"></div>
			</div>
		</div>
	);
}
