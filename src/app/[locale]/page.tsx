...
export async function generateMetadata({
	...
	if (isEu) {
		...
		description =
			"Welcome to Getxo Sailing School. Learn to sail, rent equipment and live unforgettable nautical experiences in Getxo Marina.";
	} else if (isFr) {
		title = "Accueil | Getxo Sailing School";
		description =
			"Bienvenue à Getxo Sailing School. Apprenez la voile, louez du matériel et vivez des expériences nautiques inoubliables à Getxo.";
	}
		...
		<div className="w-full">
			...
			<h1 className="sr-only">
				{locale === "eu"
					...
					: locale === "en"
						? "Getxo Sailing School | Sailing Lessons in Getxo"
						: locale === "fr"
							? "Getxo Sailing School | École de Voile à Getxo"
