			...
			<section className="relative h-screen flex items-center justify-center overflow-hidden">
				...
				<div className="container mx-auto px-6 relative z-10 text-center">
					<div className="flex flex-col items-center">
						...
						<div
							className="flex items-center gap-8 w-full max-w-4xl opacity-40 animate-fade-in"
				...
				<div className="container mx-auto px-6">
					<div className="grid lg:grid-cols-12 gap-12 items-center">
						...
						<div className="lg:col-span-1 hidden lg:block self-start pt-12">
							<span className="font-display text-9xl text-accent/10 italic leading-none">
								&quot;
							</span>
						</div>
			...
			<section className="py-32 md:py-64 relative bg-black/20">
				...
				<div className="container mx-auto px-6 relative">
					<header className="mb-32 text-center max-w-4xl mx-auto space-y-8">
						<span className="text-accent uppercase tracking-[0.6em] text-sm font-bold">
							Nuestra Esencia
						</span>
						<h2 className="text-4xl md:text-6xl lg:text-8xl font-display">
							{t("define_title")}
						</h2>
					...
					<div className="grid md:grid-cols-3 gap-0 border border-white/5">
						{[
							...
							<div
								key={i}
								className="group relative h-[600px] p-20 flex flex-col justify-end overflow-hidden border-r last:border-r-0 border-white/5"
							>
