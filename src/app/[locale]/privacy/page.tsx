					...
					<div className="space-y-12 text-foreground/80 font-light leading-loose">
						<section className="bg-white/5 p-8 rounded-sm border border-white/10 mb-12">
							<p className="text-foreground/60 leading-relaxed italic">
								En Getxo Sailing School nos tomamos muy en serio la privacidad
								de tus datos. Cumplimos estrictamente con el Reglamento General
						...
						<div>
							...
							<p>
								El responsable del tratamiento de tus datos es Getxo Bela
								Eskola, con dirección en Muelle Arriluzea s/n, 48990 Getxo.
								Puedes contactar con nosotros en info@getxobelaeskola.com.
							</p>
						</div>
						...
						<div>
							...
							<p>
								Los datos proporcionados a través de formularios de contacto o
								registro se utilizan para:
							</p>
							<ul className="list-disc pl-6 space-y-2 mt-4">
								<li>Gestionar tu inscripción en cursos y alquileres.</li>
								<li>
									Mantenerte informado sobre novedades de la escuela (si has
									aceptado la newsletter).
								</li>
								<li>
									Cumplir con las obligaciones legales de registro de
									navegantes.
								</li>
							</ul>
						</div>
						...
						<div>
							...
							<p>
								Conservaremos tus datos mientras se mantenga la relación
								comercial o durante los años necesarios para cumplir con las
						...
						<div>
							...
							<p>
								...
								Personales. Para ejercer estos derechos, envía un correo a
								info@getxobelaeskola.com adjuntando copia de tu DNI.
							</p>
						</div>
					</div>
				</div>
