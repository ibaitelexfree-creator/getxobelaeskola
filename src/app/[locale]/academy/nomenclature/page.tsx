...
export const metadata: Metadata = {
	...
	description:
		"Aprende las partes del barco mediante el método de lección de tres tiempos.",
};
			...
			<div className="container mx-auto px-4">
				<div className="max-w-4xl mx-auto mb-12 text-center">
					...
					<p className="text-lg text-white/60 font-light max-w-2xl mx-auto">
						Domina el vocabulario técnico esencial mediante el método Montessori
						de tarjetas de tres partes.
					</p>
				</div>
