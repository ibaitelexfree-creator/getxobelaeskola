...
export const metadata: Metadata = {
  ...
  description: 'Diccionario completo de términos náuticos, maniobras y partes del barco.',
};
...
export default function GlossaryPage({ params: { locale } }: GlossaryPageProps) {
