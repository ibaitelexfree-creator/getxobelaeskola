...
const MOCK_ROUTE = [
	...
	[43.355, -3.04], // Salida Abra
	[43.365, -3.06], // Punta Galea
	[43.375, -3.09], // Costa
	[43.385, -3.12], // Barrika
	[43.39, -3.15], // Plentzia approach (just illustrating a route)
	[43.395, -3.18],
	[43.39, -3.21], // Castro approach
	[43.385, -3.22], // Castro Puerto
];
	...
	return (
		<div className="w-full h-full relative">
			...
			<div className="absolute top-12 left-12 z-[1000] pointer-events-none">
				<h2 className="text-white font-display italic text-5xl drop-shadow-md">
					Ruta del Día
				</h2>
				<p className="text-white/60 text-xl font-light mt-2">
					Getxo ➔ Castro Urdiales
				</p>
			</div>
		</div>
	);
