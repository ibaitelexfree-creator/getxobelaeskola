			...
			<div className="max-w-4xl mx-auto">
				<header className="mb-12">
					<div className="flex items-center gap-4 mb-4">
						...
						<div>
							<h1 className="text-3xl font-display italic font-bold">
								Laboratorio Geoespacial
							</h1>
							<p className="text-white/40 text-sm uppercase tracking-widest">
								Tecnología de Geofencing para Getxo
							</p>
						</div>
					</div>
					<p className="text-slate-400 max-w-2xl leading-relaxed">
						Este laboratorio demuestra cómo el sistema diferencia el **agua
						navegable** de la **tierra firme** utilizando coordenadas reales de
						OpenStreetMap simplificadas para alto rendimiento.
					</p>
				</header>
								...
								<li className="flex gap-4">
									...
									<div>
										...
										<p className="text-xs text-slate-400">
											Datos reales de la costa de Getxo y el Abra de Bilbao
											descargados vía Overpass API.
										</p>
									</div>
								</li>
								<li className="flex gap-4">
									...
									<div>
										...
										<p className="text-xs text-slate-400">
											Cálculo instantáneo de colisión (Point-in-Polygon)
											ejecutado en local para cero latencia.
										</p>
									</div>
								</li>
								<li className="flex gap-4">
									...
									<div>
										...
										<p className="text-xs text-slate-400">
											Funciona tanto en el Simulador 3D (WebGL) como en el
											Tracker GPS móvil.
										</p>
									</div>
								</li>
				...
				<div className="mt-20">
					...
					<p className="text-slate-400 mb-8 max-w-3xl">
						Visualización interactiva de zonas de navegación, puntos de interés
						y áreas restringidas. Los datos se renderizan utilizando{" "}
						<strong>Leaflet</strong> con capas de OpenStreetMap.
					</p>
