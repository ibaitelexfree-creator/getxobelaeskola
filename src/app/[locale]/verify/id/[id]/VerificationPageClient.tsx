			...
			<main className="container mx-auto px-6 py-20 relative z-10">
				<div className="max-w-3xl mx-auto">
					...
					<div className="text-center mb-12 animate-in fade-in slide-in-from-top-10 duration-700">
						...
						<h1 className="text-4xl md:text-5xl font-display italic mb-2">
							Verificación de Credenciales
						</h1>
						<p className="text-white/40 uppercase tracking-[0.3em] text-[10px] font-bold">
							Getxo Bela Eskola • Registro Oficial
						</p>
					</div>
					...
					{status === "loading" && (
						<div className="bg-white/5 border border-white/10 rounded-3xl p-20 text-center animate-pulse">
							...
							<p className="text-white/40 font-display italic text-xl">
								Consultando los registros del puerto...
							</p>
						</div>
					)}
					...
					{status === "invalid" && (
						<div className="bg-red-500/5 border border-red-500/20 rounded-3xl p-16 text-center animate-in zoom-in-95 duration-500">
							...
							<p className="text-white/60 mb-8 max-w-md mx-auto">
								No hemos encontrado ningún registro oficial que coincida con el
								número proporcionado:
								<span className="block mt-2 font-mono text-white bg-white/5 p-2 rounded">
									{params.id}
								</span>
							</p>
							<Link
								href="/"
								className="inline-flex items-center gap-2 text-accent hover:underline font-bold uppercase tracking-widest text-xs"
							>
								Volver al Inicio →
							</Link>
						</div>
						...
						<div className="animate-in fade-in slide-in-from-bottom-10 duration-1000">
									...
									<div className="flex flex-col md:flex-row gap-12 items-center text-center md:text-left">
										<div className="shrink-0">
											<div className="w-32 h-40 bg-nautical-black rounded-xl border-2 border-accent/20 flex flex-col items-center justify-center text-center p-4 relative shadow-2xl">
												...
												<div className="text-[10px] text-accent font-bold font-mono">
													GBE-{data.numero.split("-")[1]}
												</div>
											</div>
										</div>
										...
										<div className="space-y-6 flex-1">
											<div>
												...
												<h2 className="text-3xl md:text-4xl font-display italic text-white mb-1">
													{params.locale === "eu"
														? data.entidad.nombre_eu
														: data.entidad.nombre_es}
												</h2>
											...
											<div className="grid grid-cols-2 gap-8 py-6 border-y border-white/10">
												...
												<div>
													...
													<div className="text-2xl font-bold text-white">
														{new Date(data.fecha_emision).toLocaleDateString(
															"es-ES",
														)}
													</div>
												</div>
											...
											<div className="flex flex-wrap gap-4 items-center">
												...
												{data.distincion && (
													<div className="flex items-center gap-2 px-4 py-2 bg-yellow-500/10 border border-yellow-500/30 rounded-full">
														<span className="text-yellow-500 text-xs text-secondary-foreground">
															⭐
														</span>
							...
							<div className="mt-8 text-center space-y-4">
								<p className="text-white/30 text-xs max-w-md mx-auto leading-relaxed">
									Esta es una página de verificación oficial de Getxo Bela
									Eskola. Los certificados emitidos a través de esta plataforma
									son inalterables y están vinculados a la bitácora académica
									del alumno.
								</p>
								<div className="pt-4 flex items-center justify-center gap-4">
									<Image
										src="/images/brand-logo-sail.png"
										alt="Getxo"
										width={100}
										height={24}
