...
export default async function CoursesPage({
	...
	const fallbackCourses = [
		{
			...
			descripcion_es:
				"Curso de iniciación a la navegación para adultos. 12 horas de formación práctica.",
			descripcion_eu:
				"Helduentzako nabigazio ikastaroa (hasiera). 12 orduko prestakuntza praktikoa.",
			precio: 180,
			duracion_h: 12,
			nivel: "iniciacion",
			categoria: {
				nombre_es: "Cursos Adultos",
				nombre_eu: "Helduentzako Ikastaroak",
			},
			imagen_url:
				"https://images.unsplash.com/photo-1544620347-c4fd4a3d5997?q=70&w=800",
		},
		{
			id: "2",
			...
			descripcion_es:
				"Campus de verano para niños de 5 a 21 años. 20 horas de diversión y vela.",
			descripcion_eu:
				"5 eta 21 urte bitarteko haurrendako udako campusa. 20 orduko dibertsioa eta bela.",
			precio: 130,
			duracion_h: 20,
			nivel: "iniciacion",
			categoria: {
				nombre_es: "Cursos Infantiles",
				nombre_eu: "Haurrentzako Ikastaroak",
			},
		...
		},
		{
			...
			descripcion_es:
				"Aprende los fundamentos del windsurf en 5 sesiones de 2 horas.",
			descripcion_eu:
				"Ikasi windsurfeko oinarriak 5 saiotan (2 ordu saio bakoitzeko).",
			precio: 150,
			duracion_h: 10,
			nivel: "iniciacion",
	...
	const displayCourses =
		allCourses && allCourses.length > 0 ? allCourses : fallbackCourses;
			...
			<section className="relative pt-48 pb-32 overflow-hidden">
				...
				<div className="container mx-auto px-6 relative z-10 text-center md:text-left">
					<header className="max-w-4xl">
						...
						<p
							className="max-w-2xl text-foreground/60 font-light text-xl leading-relaxed border-l-2 border-white/5 pl-12 mt-12 animate-fade-in"
