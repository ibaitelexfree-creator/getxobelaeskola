				...
				<header className="mb-12 border-b border-white/5 pb-8 flex justify-between items-end">
					<div>
						...
						<h1 className="text-4xl md:text-6xl font-display italic">
							Informes <span className="text-accent">Financieros</span>
						</h1>
					</div>
					<Link
						href={`/${locale}/staff`}
						className="text-[10px] uppercase tracking-widest text-white/40 hover:text-accent font-bold px-4 py-2 border border-white/10 hover:bg-white/5 transition-all"
					>
						← Volver al Panel
					</Link>
				</header>
