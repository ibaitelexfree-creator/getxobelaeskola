				...
				<div className="prose prose-invert prose-brass max-w-none">
					<section className="bg-white/5 p-8 rounded-sm border border-white/10 mb-12">
						<p className="text-foreground/60 leading-relaxed italic">
							Esta página describe el uso de cookies en el sitio web de Getxo
							Getxo Bela Eskola. Al navegar por nuestra web, aceptas el uso de
							cookies para mejorar tu experiencia de usuario.
						</p>
					</section>
					...
					<div className="space-y-12 text-foreground/80 font-light leading-loose">
						<div>
							...
							<p>
								...
								almacenan en tu ordenador o dispositivo móvil cuando los
								visitas. Se utilizan para que el sitio web funcione o funcione
								de manera más eficiente, así como para proporcionar información
						...
						<div>
							...
							<p>
								Utilizamos cookies técnicas para recordar tu sesión y
								preferencias de idioma. También podemos utilizar cookies
								analíticas de terceros (como Google Analytics) para entender
								cómo interactúan los usuarios con nuestra web y mejorar nuestros
								servicios.
							</p>
						</div>
						...
						<div>
							...
							<ul className="list-disc pl-6 space-y-4">
								<li>
									...
									funcionamiento del sitio y plataformas de membresía.
								</li>
								<li>
								...
								<li>
									<strong>Cookies de Terceros:</strong> Utilizadas para
									analítica y seguimiento de marketing (Facebook Pixel, Google
									Ads).
								</li>
							</ul>
						</div>
						...
						<div>
							...
							<p>
								...
								detalles, consulta aboutcookies.org. Puedes eliminar todas las
								cookies que ya están en tu ordenador y puedes configurar la
								mayoría de los navegadores para que no se instalen.
							</p>
						</div>
					</div>
				</div>
