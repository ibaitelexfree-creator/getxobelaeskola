...
import { Anchor, ArrowLeft, Check, Shield, Sparkles, Star } from "lucide-react";
	...
	return (
		<main className="min-h-screen bg-nautical-black text-white pb-24 relative overflow-hidden">
			...
			<header className="fixed top-0 left-0 right-0 z-50 px-6 py-6 bg-nautical-black/80 backdrop-blur-md flex items-center gap-4">
				...
				<h1 className="text-lg font-display italic text-white">
					Club de Navegación
				</h1>
			</header>
			...
			<div className="relative z-10 pt-32 px-6">
				...
				>
					<div className="absolute top-0 right-0 p-8 opacity-10 text-9xl group-hover:scale-110 transition-transform duration-1000">
						⚓
					</div>
					...
					<div className="relative z-10 h-full flex flex-col justify-between">
						<div>
							...
							<p className="text-white/60 text-sm max-w-xs">
								Únete a la comunidad más exclusiva del Cantábrico y navega sin
								límites.
							</p>
						</div>
						...
						<div className="mt-8">
							...
							<p className="text-xs text-brass-gold mt-1 uppercase tracking-wider font-bold">
								Sin permanencia
							</p>
						</div>
					</div>
				...
				<div className="space-y-6 mb-12">
					<h3 className="text-xs uppercase tracking-widest text-white/40 font-bold ml-1">
				...
				<div className="fixed bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-nautical-black via-nautical-black/95 to-transparent z-40">
					...
					<p className="text-center text-[10px] text-white/20 mt-4 px-8">
						El cobro se realizará de forma segura a través de Stripe. Puedes
