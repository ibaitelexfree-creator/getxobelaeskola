...
export default async function DailyChallengePage({
	...
	const _t = await getTranslations("student_dashboard.daily_challenge");
		...
		<main className="min-h-screen bg-nautical-black pt-24 pb-12 px-6">
			<div className="max-w-md mx-auto">
				...
				<header className="mb-10">
					<h1 className="text-3xl font-display text-white italic mb-2">
						Reto Diario
					</h1>
					<p className="text-white/40 text-sm">
						Demuestra tus conocimientos náuticos y gana XP.
					</p>
				</header>
