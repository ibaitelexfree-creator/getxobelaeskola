...
export async function generateMetadata({
	...
	if (isEu) {
		...
		title = "Contact Us";
		description =
			"Get in touch with us. We are here to answer your sailing questions in Getxo.";
	} else if (isFr) {
		title = "Contactez-nous";
		description =
			"Contactez-nous. Nous sommes là pour répondre à vos questions sur la navigation à Getxo.";
	}
			...
			<div className="container mx-auto">
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-32 items-start">
					...
					<div className="animate-fade-in" style={{ animationDelay: "0.2s" }}>
						...
						<div className="space-y-16">
							<div className="group space-y-4">
								<p className="text-xs uppercase tracking-[0.4em] text-foreground/20 font-bold group-hover:text-accent transition-colors duration-500">
									{t("location_label")}
								</p>
								<p className="text-3xl font-display italic leading-tight whitespace-pre-line text-white/80 group-hover:text-white transition-colors duration-500">
									{t("location_val")}
								</p>
							</div>
							...
							<div className="group space-y-4">
								...
								<div className="space-y-2">
									<a
										...
										className="text-3xl font-display italic text-white/80 hover:text-accent transition-colors duration-500 tracking-wide block"
									>
										info@getxobelaeskola.com
									</a>
									<a
										href="tel:+34944916632"
										className="text-3xl font-display italic text-white/80 hover:text-accent transition-colors duration-500 tracking-wider block"
									>
										(+34) 944 916 632
									</a>
								</div>
							...
							<div className="group space-y-4">
								...
								<p className="text-3xl font-display italic leading-tight whitespace-pre-line text-white/80 group-hover:text-white transition-colors duration-500 tracking-wide">
									{t("hours_val")}
								</p>
							</div>
						</div>
					...
					<div className="relative group lg:sticky lg:top-48">
						...
						<div
							className="relative glass-panel p-12 md:p-16 border-white/5 bg-white/[0.02] animate-fade-in"
