...
# Resolve tests as 'ours'
resolve_conflict('src/lib/geospatial/water-check.test.ts', 'ours')
resolve_conflict('src/lib/auth-guard.test.ts', 'ours')
resolve_conflict('src/app/api/logbook/upload-track/route.test.ts', 'ours')

# Resolve index.js as 'theirs' (Jules' version)
resolve_conflict('orchestration/index.js', 'theirs')
