...
export const RecommendationBanner: React.FC<RecommendationBannerProps> = ({ topic, onStart }) => {
    if (!topic) return null;

    return (
        <div className="w-full relative overflow-hidden rounded-3xl p-8 mb-12 border border-accent/20 group cursor-pointer" onClick={onStart}>
            {/* Background Effects */}
