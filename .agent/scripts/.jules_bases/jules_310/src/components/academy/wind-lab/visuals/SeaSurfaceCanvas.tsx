...
import { WindLabState } from '../physics/PhysicsEngine';

interface SeaSurfaceCanvasProps {
    state: WindLabState;
}

export const SeaSurfaceCanvas: React.FC<SeaSurfaceCanvasProps> = ({ state }) => {
    ...
    useEffect(() => {
        ...
        const draw = (time: number) => {
            ...
            currentSpeed.current += (currentState.boatSpeed - currentSpeed.current) * 0.1;
