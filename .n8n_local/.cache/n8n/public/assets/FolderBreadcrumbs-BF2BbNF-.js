...
`,options:{}},type:`n8n-nodes-base.gmail`,typeVersion:2.1,position:[1264,-192],id:`4a23b2b5-21f7-4a63-a1ab-9f18d6ce2e6a`,name:`Send output via email using Gmail`,webhookId:`65c7b462-bb4a-400c-a556-ef408efcd208`,notesInFlow:!0,notes:`Double-click here to connect!`}],pinData:{},connections:{"Get city latitude and longitude":{main:[[{node:`Limit`,type:`main`,index:0}]]},"Get weather":{main:[[{node:`Get today's high and low`,type:`main`,index:0}]]},"Set your location":{main:[[{node:`Get city latitude and longitude`,type:`main`,index:0}]]},Merge:{main:[[{node:`Aggregate`,type:`main`,index:0}]]},Aggregate:{main:[[{node:`Select output for the email`,type:`main`,index:0}]]},"Get today's high and low":{main:[[{node:`Merge`,type:`main`,index:2}]]},Limit:{main:[[{node:`Get weather`,type:`main`,index:0}]]},"1. Click 'Execute workflow’":{main:[[{node:`Set current day and month`,type:`main`,index:0},{node:`Set your location`,type:`main`,index:0},{node:`Set exchange currency`,type:`main`,index:0}]]},"Set current day and month":{main:[[{node:`Get a historical fact`,type:`main`,index:0}]]},"Set exchange currency":{main:[[{node:`Get exchange rates`,type:`main`,index:0}]]},"Get a historical fact":{main:[[{node:`Merge`,type:`main`,index:0}]]},"Get exchange rates":{main:[[{node:`Merge`,type:`main`,index:1}]]},"Select output for the email":{main:[[]]}}};var F=`N8N_READY_TO_RUN_WORKFLOWS_DISMISSED`;const I=O(w.EXPERIMENT_READY_TO_RUN_WORKFLOWS,()=>{let t=C(),n=g(),r=k(),i=E(),a=b(),o=T(),s=e(()=>[D.variantReadyToRun,D.variantReadyToRun2,D.variantReadyToRun3].includes(a.getVariant(D.name)?.toString()??``)&&o.userIsTrialing),c=h(F,!1),l=e(()=>c.value),u=()=>{c.value=!0},d=e=>{t.track(`User created ready to run workflows`,{source:e})},f=()=>{t.track(`User dismissed ready to run workflows callout`)},p=e=>{t.track(`User opened ready to run workflow`,{template:e})},m=(e,n)=>{t.track(`User executed ready to run workflow`,{template:e,status:n})};function _(){switch(a.getVariant(D.name)){case D.variantReadyToRun:return n.baseText(`workflows.readyToRunWorkflows.card`);case D.variantReadyToRun2:return n.baseText(`workflows.readyToRunWorkflows.card2`);case D.variantReadyToRun3:return n.baseText(`workflows.readyToRunWorkflows.card3`);default:return``}}function v(){switch(a.getVariant(D.name)){case D.variantReadyToRun:return n.baseText(`workflows.readyToRunWorkflows.callout`);case D.variantReadyToRun2:return n.baseText(`workflows.readyToRunWorkflows.callout2`);case D.variantReadyToRun3:return n.baseText(`workflows.readyToRunWorkflows.callout3`);default:return``}}return{isFeatureEnabled:s,isCalloutDismissed:l,createWorkflows:async(e,t)=>{let a=await r.createFolder(n.baseText(`workflows.readyToRunWorkflows.folder.name`),e,t),o={...j,parentFolderId:a.id},s={...M,parentFolderId:a.id},c={...N,parentFolderId:a.id},l={...P,parentFolderId:a.id};return await i.createNewWorkflow(l),await i.createNewWorkflow(c),await i.createNewWorkflow(s),await i.createNewWorkflow(o),u(),a},dismissCallout:u,trackCreateWorkflows:d,trackDismissCallout:f,trackOpenWorkflow:p,trackExecuteWorkflow:m,getCardText:_,getCalloutText:v}});var L={key:2},R=y(s({__name:`FolderBreadcrumbs`,props:{currentFolder:{default:null},actions:{default:()=>[]},hiddenItemsTrigger:{default:`click`},currentFolderAsLink:{type:Boolean,default:!1},visibleLevels:{default:1}},emits:[`itemSelected`,`action`,`itemDrop`,`projectDrop`],setup(s,{emit:h}){let y=s,b=h,C=g(),w=x(),T=k(),E=i(new Promise(()=>{})),D=i(new Set),O=e(()=>w.projectNavActiveId===`shared`),j=e(()=>{if(!O.value)return w.currentProject??w.personalProject??void 0}),M=e(()=>j.value?j.value.type===S.Personal?C.baseText(`projects.menu.personal`):j.value.name:O.value?C.baseText(`projects.menu.shared`):``),N=e(()=>T.draggedElement!==null),P=e(()=>F.value[0]?.parentFolder!==void 0),F=e(()=>{if(D.value.clear(),!y.currentFolder||O.value)return[];let e=[],t=y.visibleLevels===2?T.getCachedFolder(y.currentFolder.parentFolder??``):null;return t&&(e.push({id:t.id,label:t.name,href:`/projects/${j.value?.id}/folders/${t.id}/workflows`,parentFolder:t.parentFolder}),D.value.add(t.id)),e.push({id:y.currentFolder.id,label:y.currentFolder.name,parentFolder:y.currentFolder.parentFolder,href:y.currentFolderAsLink?`/projects/${j.value?.id}/folders/${y.currentFolder.id}/workflows`:void 0}),j.value&&D.value.add(j.value.id),D.value.add(y.currentFolder.id),e}),I=async()=>{if(!M.value||!y.currentFolder?.parentFolder||O.value||!j.value)E.value=Promise.resolve([]);else try{let e=(await T.getHiddenBreadcrumbsItems({id:j.value.id,name:M.value},y.currentFolder.parentFolder,{addLinks:!0})).filter(e=>!D.value.has(e.id));E.value=Promise.resolve(e)}catch{E.value=Promise.resolve([])}},R=e=>{b(`itemSelected`,e)},z=e=>{b(`action`,e)},B=()=>{j.value?.name&&b(`projectDrop`,j.value.id,j.value.name)},V=()=>{!N.value||!j.value?.name||(T.activeDropTarget={type:`project`,id:j.value?.id,name:j.value?.name})},H=e=>{N.value&&(T.activeDropTarget={type:`folder`,id:e.id,name:e.label})};return l(()=>y.currentFolder?.parentFolder,()=>{E.value=new Promise(()=>{})},{immediate:!0}),a(()=>{E.value=Promise.resolve([])}),(e,i)=>(f(),t(`div`,{class:m({[e.$style.container]:!0,[e.$style.dragging]:N.value}),"data-test-id":`folder-breadcrumbs`},[F.value.length?(f(),c(r(_),{key:0,"drag-active":N.value,"onUpdate:dragActive":i[0]||=e=>N.value=e,items:F.value,"highlight-last-item":!1,"path-truncated":P.value,"hidden-items":P.value?E.value:void 0,"hidden-items-trigger":y.hiddenItemsTrigger,onTooltipOpened:I,onItemSelected:R,onItemHover:H,onItemDrop:i[1]||=e=>b(`itemDrop`,e)},p({append:d(()=>[u(e.$slots,`append`)]),_:2},[j.value?{name:`prepend`,fn:d(()=>[o(A,{"current-project":j.value,"is-dragging":N.value,onProjectDrop:B,onProjectHover:V},null,8,[`current-project`,`is-dragging`])]),key:`0`}:void 0]),1032,[`drag-active`,`items`,`path-truncated`,`hidden-items`,`hidden-items-trigger`])):j.value||O.value?(f(),t(`div`,{key:1,class:m(e.$style[`home-project`])},[o(A,{"current-project":j.value,"is-shared":O.value,"is-dragging":N.value,onProjectDrop:B,onProjectHover:V},null,8,[`current-project`,`is-shared`,`is-dragging`]),u(e.$slots,`append`)],2)):(f(),t(`div`,L,[u(e.$slots,`append`)])),F.value&&s.actions?.length?(f(),c(r(v),{key:3,actions:s.actions,class:m(e.$style[`action-toggle`]),theme:`dark`,"data-test-id":`folder-breadcrumbs-actions`,onAction:z},null,8,[`actions`,`class`])):n(``,!0)],2))}}),[[`__cssModules`,{$style:{container:`_container_133pr_125`,"home-project":`_home-project_133pr_130`,"action-toggle":`_action-toggle_133pr_135`}}]]);export{I as n,R as t};
//# sourceMappingURL=FolderBreadcrumbs-BF2BbNF-.js.map